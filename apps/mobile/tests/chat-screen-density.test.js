...
test('keeps agent selection in the navigation header for the mobile chat screen', () => {
  ...
  assert.match(screenSource, /useChatRuntimeNavigationHeaderChromeOptions\(\{\s+navigation,\s+colors: chatRuntimeChromeEnvironment\.colors,\s+spinnerSource: chatRuntimeSpinnerSource,/);
  ...
  assert.match(chatScreenSource, /chatRuntimeChromeEnvironment,/);
...
test('uses shared runtime presentation for the mobile chat viewport and loading state', () => {
  ...
  assert.match(screenSource, /const chatMessageRuntimeSurface = createChatMessageRuntimeChromeProps<PredefinedPromptSummary, Loop>\(\{\s+colors: chatRuntimeChromeEnvironment\.colors,\s+platform: chatRuntimeChromeEnvironment\.platform,\s+spinnerSource: chatRuntimeSpinnerSource,/);
  ...
  assert.match(screenSource, /styles: \{\s+actionStyles: chatMessageConversationThreadStyles\.actionSet,\s+threadStyles: chatMessageConversationThreadStyles\.runtimeThread,\s+promptEditorStyles: promptEditorModalStyles,\s+\},/);
  assert.doesNotMatch(screenSource, /threadList: \{[\s\S]*?threadStyles: chatMessageConversationThreadStyles\.runtimeThread,/);
...
test('derives visible assistant content from respond_to_user output and suppresses raw tool payloads', () => {
  ...
  assert.match(screenSource, /styles: \{[\s\S]*?threadStyles: chatMessageConversationThreadStyles\.runtimeThread,/);
  assert.doesNotMatch(screenSource, /threadList: \{[\s\S]*?threadStyles: chatMessageConversationThreadStyles\.runtimeThread,/);
...
test('lets mobile branch linked desktop conversations from individual messages', () => {
  ...
  assert.match(screenSource, /styles: \{\s+actionStyles: chatMessageConversationThreadStyles\.actionSet,/);
  assert.doesNotMatch(screenSource, /threadList: \{[\s\S]*?actionStyles: chatMessageConversationThreadStyles\.actionSet,/);
