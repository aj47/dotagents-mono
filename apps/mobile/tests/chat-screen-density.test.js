...
test('shows desktop-style retry status updates from shared runtime presentation', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageRetryStatusView\s+\{\.\.\.retryStatusContent\.meta\.props\}/);
  assert.match(chatMessageChromeSource, /const metaContent = retryStatusContent\.meta\.content;/);
