...
- Commit range: `bd56d13a07e1a6df5234fdc7d4451fec98974697..a8a3d641fff65825d0ed1c95360ff569023b63f9`
...
- QA feedback: QA round 2 found the evidence provenance was still inconsistent: the ledger cited `bd56d13a07e1a6df5234fdc7d4451fec98974697..7398a360412a3bff8ba4eb8b88e63bd845f65559`, but the same `Change` block described the later QA-remediation work that landed in `a8a3d641fff65825d0ed1c95360ff569023b63f9` (`apps/desktop/src/main/llm.final-output.test.ts` plus the timeout-path fix in `apps/desktop/src/main/llm.ts`). This pass corrects the provenance to the actual reviewed commit span for the iteration.
