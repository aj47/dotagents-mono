...
test('derives tool execution card status from displayed non-meta tool entries', () => {
  ...
  assert.doesNotMatch(chatMessageChromeSource, /pendingResultParts\.spinner\.(size|color)/);
  assert.doesNotMatch(chatMessageChromeSource, /pendingResultParts\.label\.(style|text)/);
  ...
  assert.match(sessionPresentationSource, /label: \{\s+props: \{\s+props: \{\s+style: \[\s+styles\.text,\s+badge\.isSuccess \? styles\.textSuccess : styles\.textError,/);
  ...
  assert.doesNotMatch(chatMessageChromeSource, /resultBadgeParts\.icon\.(name|size|color)/);
  assert.doesNotMatch(chatMessageChromeSource, /resultBadgeParts\.label\.(style|text)/);
