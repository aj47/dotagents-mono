...
test('scales the mobile chat mic control down and slightly tightens the composer row on compact viewports', () => {
  ...
  assert.match(screenSource, /const composerRowVerticalPadding = isCompactViewport \? 3 : spacing\.xs;/);
