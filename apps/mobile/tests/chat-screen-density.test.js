...
test('derives tool execution card status from displayed non-meta tool entries', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionCompactRowIconCell\s+\{\.\.\.compactRowParts\.toggleIcon\.container\.props\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionCompactRowIcon\s+\{\.\.\.compactRowParts\.toggleIcon\.icon\.props\}/);
  assert.doesNotMatch(chatMessageChromeSource, /compactRowParts\.(container|name)\.(style|accessibilityLabel|text|numberOfLines|ellipsizeMode)/);
  assert.doesNotMatch(chatMessageChromeSource, /compactRowParts\.(leadingIcon|toggleIcon)\.style/);
  assert.doesNotMatch(chatMessageChromeSource, /compactRowParts\.(leadingIcon|toggleIcon)\.icon\.(name|size|color)/);
  assert.doesNotMatch(chatMessageChromeSource, /compactRowParts\.statusIndicator\.(style|spinner\.(size|color)|icon\.(name|size|color))/);
  ...
  assert.match(chatMessageChromeSource, /const expandHintContent = detailHeaderParts\.expandHint\.content;/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionDetailHeaderToolName\s+\{\.\.\.detailHeaderParts\.toolName\.props\}/);
  ...
  assert.match(sessionPresentationSource, /toolName: \{\s+props: \{\s+props: \{\s+style: styles\.toolName,/);
  ...
  assert.doesNotMatch(chatMessageChromeSource, /detailHeaderParts\.toolName\.(style|text)/);
  assert.doesNotMatch(chatMessageChromeSource, /detailHeaderParts\.expandHint\.(style|icon|label)\.(name|size|color|style|text)/);
  assert.doesNotMatch(chatMessageChromeSource, /detailHeaderParts\.expandHint\.(icon|label)\./);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionResultHeader\s+\{\.\.\.resultSectionParts\.header\.props\}/);
  ...
  assert.doesNotMatch(chatMessageChromeSource, /resultSectionParts\.(header|payloadBlock)\.(payloadRenderState|resultBadge|compactText|content|styles)/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionPayloadSectionView\s+\{\.\.\.payloadSectionParts\.headerRow\.props\}/);
  ...
  assert.doesNotMatch(chatMessageChromeSource, /payloadSectionParts\.(payloadMeta|copyButton|payloadBlock)\.(renderState|onPress|compactText|content|styles)/);
...
test('uses tool activities wording consistently for grouped tool activity labels', () => {
  ...
  assert.match(sessionPresentationSource, /countBadge: \{\s+shouldRender: renderState\.summary\.shouldShowToolCallCount,[\s\S]*?props: \{[\s\S]*?container: \{[\s\S]*?props: \{[\s\S]*?accessibilityLabel: renderState\.summary\.toolCallCountLabel,/);
  ...
  assert.match(toolActivityGroupToggleComponentSource, /<ChatMessageToolActivityGroupCountBadge\s+\{\.\.\.toggleParts\.countBadge\.props\}/);
  ...
  assert.match(sessionPresentationSource, /preview: \{[\s\S]*?props: \{[\s\S]*?props: \{[\s\S]*?numberOfLines: renderState\.surface\.preview\.numberOfLines,[\s\S]*?ellipsizeMode: renderState\.surface\.preview\.ellipsizeMode,[\s\S]*?text: renderState\.summary\.previewText,/);
  ...
  assert.match(sessionPresentationSource, /toggleIcon: \{[\s\S]*?props: renderState\.headerToggleIcon,/);
  assert.match(toolActivityGroupToggleComponentSource, /<ChatMessageToolActivityGroupIcon\s+\{\.\.\.toggleParts\.toggleIcon\.props\}/);
  assert.doesNotMatch(toolActivityGroupToggleComponentSource, /toggleParts\.toggleIcon\.(name|size|color)/);
  ...
  assert.match(sessionPresentationSource, /label: \{[\s\S]*?props: \{[\s\S]*?props: \{[\s\S]*?style: styles\.text,[\s\S]*?text: renderState\.footerButton\.label,/);
  assert.match(chatMessageChromeSource, /export function ChatMessageToolActivityGroupFooterLabel/);
  assert.match(toolActivityGroupFooterComponentSource, /<ChatMessageToolActivityGroupFooterLabel\s+\{\.\.\.footerParts\.label\.props\}/);
  ...
  assert.doesNotMatch(toolActivityGroupFooterComponentSource, /footerParts\.label\.text/);
