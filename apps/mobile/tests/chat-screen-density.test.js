...
test('derives tool execution card status from displayed non-meta tool entries', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionPayloadMetaText\s+\{\.\.\.payloadMetaParts\.label\.props\}/);
  ...
  assert.doesNotMatch(chatMessageChromeSource, /payloadMetaParts\.(label|payloadType)\.(style|text)/);
