---
sidebar_position: 2
sidebar_label: "MCP Server Config"
---
...
- **[MCP Tools](/tools/mcp)** — Using tools in conversations
- **[Settings Reference](settings)** — All configuration options
- **[Agent Profiles](/agents/profiles)** — Per-agent tool access
