...
test('derives tool execution card status from displayed non-meta tool entries', () => {
  ...
  assert.match(chatMessageChromeSource, /compactListParts\.rows\.map\(\(row\) => \(/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionResultHeaderView\s+\{\.\.\.resultHeaderParts\.meta\.props\}/);
  ...
  assert.match(sessionPresentationSource, /header: \{\s+props: \{\s+style: styles\.header,/);
  assert.match(sessionPresentationSource, /meta: \{\s+props: \{\s+style: styles\.meta,/);
  ...
  assert.doesNotMatch(chatMessageChromeSource, /resultHeaderParts\.(payloadMeta|resultBadge|copyButton)\.(renderState|styles|badge|onPress)/);
  assert.doesNotMatch(chatMessageChromeSource, /resultHeaderParts\.characterCount\.(style|label)/);
  ...
  assert.match(chatMessageChromeSource, /const errorBlockContent = errorBlockParts\.content;/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionErrorBlockText\s+\{\.\.\.errorBlockContent\.label\.props\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionCopyButton\s+\{\.\.\.errorBlockContent\.copyButton\.props\}/);
  ...
  assert.match(sessionPresentationSource, /content: \{\s+label: \{\s+props: \{\s+props: \{\s+style: styles\.label,/);
  assert.match(sessionPresentationSource, /content: \{[\s\S]*?copyButton: \{\s+props: \{\s+renderState: copyButtonRenderState,\s+onPress: onCopyPress,\s+styles: styles\.copyButton,/);
  assert.match(sessionPresentationSource, /content: \{[\s\S]*?error: \{\s+props: \{\s+props: \{\s+style: styles\.text,/);
  assert.doesNotMatch(chatMessageChromeSource, /errorBlockParts\.(sectionStyle|headerRowStyle)/);
  assert.doesNotMatch(chatMessageChromeSource, /errorBlockParts\.(label|copyButton|error)\./);
  assert.doesNotMatch(chatMessageChromeSource, /errorBlockContent\.copyButton\.(renderState|onPress|styles)/);
  assert.doesNotMatch(chatMessageChromeSource, /errorBlockContent\.(label|error)\.(style|text)/);
