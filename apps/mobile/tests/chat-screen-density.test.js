...
test('lets mobile respond to desktop tool approval requests from progress updates', () => {
  ...
  assert.match(chatMessageChromeSource, /return createChatRuntimeConversationToolApprovalMobileProps\(\{ cardState \}\);/);
...
test('shows desktop-style retry status updates from shared runtime presentation', () => {
  ...
  assert.match(chatMessageChromeSource, /return createChatRuntimeConversationRetryStatusMobileProps\(\{ renderState \}\);/);
...
test('renders delegated agent progress as compact desktop-style mobile chrome', () => {
  ...
  assert.match(chatMessageChromeSource, /return createChatRuntimeDelegationCardMobileProps\(cardInput\);/);
