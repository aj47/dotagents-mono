...
test('keeps the TTS control inline with assistant message text instead of on a detached row', () => {
  ...
  assert.match(chatMessageChromeSource, /hitSlop=\{collapsedPreviewParts\.pressable\.hitSlop\}/);
  assert.match(chatMessageChromeSource, /numberOfLines=\{collapsedPreviewParts\.text\.numberOfLines\}/);
  assert.match(chatMessageChromeSource, /\{collapsedPreviewParts\.text\.text\}/);
  ...
  assert.match(sessionPresentationSource, /export function createChatRuntimeConversationCollapsedPreviewMobilePropsParts/);
  assert.match(chatMessageChromeSource, /onPress=\{collapsedPreviewParts\.pressable\.onPress\}/);
  assert.match(chatMessageChromeSource, /disabled=\{collapsedPreviewParts\.pressable\.disabled\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{collapsedPreviewParts\.pressable\.accessibilityRole\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{collapsedPreviewParts\.pressable\.accessibilityLabel\}/);
  assert.match(chatMessageChromeSource, /accessibilityHint=\{collapsedPreviewParts\.pressable\.accessibilityHint\}/);
  assert.match(chatMessageChromeSource, /accessibilityState=\{collapsedPreviewParts\.pressable\.accessibilityState\}/);
  assert.match(chatMessageChromeSource, /aria-expanded=\{collapsedPreviewParts\.pressable\.ariaExpanded\}/);
  assert.match(chatMessageChromeSource, /hitSlop=\{collapsedPreviewParts\.pressable\.hitSlop\}/);
  assert.match(chatMessageChromeSource, /style=\{collapsedPreviewParts\.pressable\.style\}/);
  ...
  assert.match(chatMessageChromeSource, /style=\{collapsedPreviewParts\.text\.style\}/);
  assert.match(chatMessageChromeSource, /numberOfLines=\{collapsedPreviewParts\.text\.numberOfLines\}/);
...
test('replaces the empty mobile chat home state with quick-start launchers', () => {
  ...
  assert.match(chatMessageChromeSource, /onPress=\{item\.pressable\.onPress\}/);
  ...
  assert.match(chatMessageChromeSource, /style=\{item\.addIcon\.style\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{item\.pressable\.accessibilityRole\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{item\.pressable\.accessibilityLabel\}/);
  ...
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{actions\.delete\.pressable\.accessibilityLabel\}/);
...
test('lets mobile edit and delete desktop saved prompts from quick-start cards', () => {
  ...
  assert.match(chatMessageChromeSource, /item\.pressable\.accessibilityLabel/);
  assert.match(chatMessageChromeSource, /item\.pressable\.accessibilityHint/);
  ...
  assert.match(chatMessageChromeSource, /name=\{actions\.edit\.icon\.name\}/);
  assert.match(chatMessageChromeSource, /size=\{actions\.edit\.icon\.size\}/);
  assert.match(chatMessageChromeSource, /color=\{actions\.edit\.iconColors\.color\}/);
  assert.match(chatMessageChromeSource, /\{actions\.edit\.label\.text\}/);
  assert.match(chatMessageChromeSource, /name=\{actions\.delete\.icon\.name\}/);
  assert.match(chatMessageChromeSource, /size=\{actions\.delete\.icon\.size\}/);
  assert.match(chatMessageChromeSource, /color=\{actions\.delete\.iconColors\.color\}/);
  ...
  assert.match(chatMessageChromeSource, /transparent=\{modalParts\.modal\.transparent\}/);
  assert.match(chatMessageChromeSource, /animationType=\{modalParts\.modal\.animationType\}/);
  ...
  assert.match(chatMessageChromeSource, /behavior=\{modalParts\.keyboardAvoidingView\.behavior\}/);
  ...
  assert.match(chatMessageChromeSource, /activeOpacity=\{modalParts\.closeButton\.activeOpacity\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{modalParts\.closeButton\.accessibilityRole\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{modalParts\.closeButton\.accessibilityLabel\}/);
  assert.match(chatMessageChromeSource, /disabled=\{modalParts\.closeButton\.disabled\}/);
  assert.match(chatMessageChromeSource, /accessibilityState=\{modalParts\.closeButton\.accessibilityState\}/);
  assert.match(chatMessageChromeSource, /onRequestClose=\{modalParts\.modal\.onRequestClose\}/);
  assert.match(chatMessageChromeSource, /style=\{modalParts\.header\.style\}/);
  assert.match(chatMessageChromeSource, /style=\{modalParts\.closeButton\.style\}/);
  assert.match(chatMessageChromeSource, /renderState: PromptLibraryEditorMobileRenderState;/);
  assert.match(chatMessageChromeSource, /name=\{modalParts\.closeIcon\.name\}/);
  assert.match(chatMessageChromeSource, /size=\{modalParts\.closeIcon\.size\}/);
  assert.match(chatMessageChromeSource, /color=\{modalParts\.closeIcon\.color\}/);
  assert.match(chatMessageChromeSource, /\{modalParts\.nameLabel\.text\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{modalParts\.nameInput\.accessibilityLabel\}/);
  assert.match(chatMessageChromeSource, /placeholder=\{modalParts\.nameInput\.placeholder\}/);
  assert.match(chatMessageChromeSource, /\{modalParts\.contentLabel\.text\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{modalParts\.contentInput\.accessibilityLabel\}/);
  assert.match(chatMessageChromeSource, /placeholder=\{modalParts\.contentInput\.placeholder\}/);
  ...
  assert.match(chatMessageChromeSource, /style=\{modalParts\.keyboardAvoidingView\.style\}/);
  assert.match(chatMessageChromeSource, /behavior=\{modalParts\.keyboardAvoidingView\.behavior\}/);
  ...
  assert.match(chatMessageChromeSource, /placeholderTextColor=\{modalParts\.nameInput\.placeholderTextColor\}/);
  assert.match(chatMessageChromeSource, /placeholderTextColor=\{modalParts\.contentInput\.placeholderTextColor\}/);
  assert.match(chatMessageChromeSource, /multiline=\{modalParts\.contentInput\.multiline\}/);
  assert.match(chatMessageChromeSource, /textAlignVertical=\{modalParts\.contentInput\.textAlignVertical\}/);
  ...
  assert.match(chatMessageChromeSource, /activeOpacity=\{modalParts\.cancelButton\.activeOpacity\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{modalParts\.cancelButton\.accessibilityRole\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{modalParts\.cancelButton\.accessibilityLabel\}/);
  ...
  assert.match(chatMessageChromeSource, /activeOpacity=\{modalParts\.saveButton\.activeOpacity\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{modalParts\.saveButton\.accessibilityRole\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{modalParts\.saveButton\.accessibilityLabel\}/);
  assert.match(chatMessageChromeSource, /accessibilityState=\{modalParts\.saveButton\.accessibilityState\}/);
  ...
  assert.match(chatMessageChromeSource, /disabled=\{modalParts\.saveButton\.disabled\}/);
  assert.match(chatMessageChromeSource, /modalParts\.actions\.style/);
