...
describe("desktop MCP tools renderer client", () => {
  ...
  it("keeps MCP tool UIs off direct tool IPC channels", () => {
    ...
    expect(mcpToolManagerSource).toContain("restoreMcpToolEnabledStatesInList(updatedTools, failedOriginalStates)")
    ...
    expect(mcpConfigManagerSource).toContain("setMcpToolEnabledInList(prevTools, toolName, enabled)")
    expect(mcpConfigManagerSource).toContain("setMcpSourceToolsEnabledInList(tools, serverName, enable)")
    expect(mcpConfigManagerSource).toContain("setMcpToolsEnabledByNameInList(")
    expect(mcpConfigManagerSource).toContain("restoreMcpToolEnabledStatesInList(updatedTools, failedOriginalStates)")
    expect(mcpConfigManagerSource).toContain("countEnabledMcpTools(toolsFromEnabledServers)")
