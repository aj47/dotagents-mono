...
test('keeps agent selection in the navigation header for the mobile chat screen', () => {
  ...
  assert.match(screenSource, /const headerSurface = mobileHeaderSurface;/);
  assert.match(screenSource, /const headerAgentSelectorRenderState = getChatRuntimeAgentSelectorMobileRenderState\(\{\s+agentLabel: getChatRuntimeCurrentAgentLabel\(\),\s+colors: theme\.colors,\s+\}\);/);
  ...
  assert.match(screenSource, /headerAgentSelectorChip:\s*\{[\s\S]*?flexDirection:\s*headerSurface\.agentSelectorChip\.flexDirection,[\s\S]*?alignItems:\s*headerSurface\.agentSelectorChip\.alignItems,[\s\S]*?backgroundColor:\s*headerAgentSelectorRenderState\.chip\.backgroundColor/);
  ...
  assert.match(screenSource, /headerAgentSelectorText:\s*\{[\s\S]*?fontSize:\s*headerSurface\.agentSelectorText\.fontSize,[\s\S]*?color:\s*headerAgentSelectorRenderState\.text\.color/);
...
test('lets mobile respond to desktop tool approval requests from progress updates', () => {
  ...
  assert.match(screenSource, /const toolApprovalRenderState = m\.toolApproval\s+\? getChatRuntimeToolApprovalMobileRenderState\(\{\s+toolName: m\.toolApproval\.toolName,\s+isArgumentsExpanded: isToolApprovalExpanded,\s+isResponding: isToolApprovalResponding,\s+colors: theme\.colors,/);
...
test('renders delegated agent progress as compact desktop-style mobile chrome', () => {
  ...
  assert.match(screenSource, /formatChatRuntimeDelegationAccessibilityLabel,/);
  assert.match(screenSource, /getChatRuntimeDelegationConversationPreviewMoreActionState,/);
  ...
  assert.match(screenSource, /conversationPreviewMaxRows:\s*mobileRuntimeDelegationCard\.conversationPreviewMaxRows/);
  assert.match(screenSource, /conversationPreviewMaxLength:\s*mobileRuntimeDelegationCard\.conversationPreviewMaxLength/);
  assert.match(screenSource, /includeAllConversationPreview:\s*isDelegationConversationPreviewExpanded/);
  assert.match(screenSource, /toolPreviewMaxRows:\s*mobileRuntimeDelegationCard\.toolPreviewMaxRows/);
  assert.match(screenSource, /includeAllToolPreview:\s*isDelegationToolPreviewExpanded/);
  assert.match(screenSource, /const delegationPresentation = delegationCardState\?\.presentation \?\? null;/);
  assert.match(screenSource, /const delegationMessageCount = delegationPresentation\?\.messageCount \?\? 0;/);
  ...
  assert.match(screenSource, /accessibilityLabel: formatChatRuntimeDelegationAccessibilityLabel\(/);
  ...
  assert.match(screenSource, /const delegationMessageCountLabel = delegationMessageCount > 0\s+\? formatChatRuntimeDelegationMessageCount\(delegationMessageCount\)\s+: null;/);
  assert.match(screenSource, /const isDelegationConversationPreviewExpanded = m\.delegation/);
  assert.match(screenSource, /getChatDisplayExpansionState\(expandedDelegationConversationPreviews, m\.delegation\.runId\)/);
  assert.match(screenSource, /const delegationConversationPreviewState = delegationCardState\?\.conversationPreview \?\? null;/);
  assert.match(screenSource, /const delegationConversationPreviewRows = delegationConversationPreviewState\?\.rows \?\? \[\];/);
  assert.match(screenSource, /const delegationHiddenConversationCount = delegationConversationPreviewState\?\.hiddenCount \?\? 0;/);
  assert.match(screenSource, /const delegationConversationPreviewMoreAction = getChatRuntimeDelegationConversationPreviewMoreActionState\(\s*delegationHiddenConversationCount,\s*\);/);
  assert.match(screenSource, /conversationPreview: \{\s+rows: delegationConversationPreviewRows,\s+roleStyles: delegationConversationPreviewRoleStyles,\s+hiddenCount: delegationHiddenConversationCount,\s+moreAction: delegationConversationPreviewMoreAction,/);
  ...
  assert.match(screenSource, /setExpandedDelegationConversationPreviews\(\(current\) =>\s*setChatDisplayExpansionState\(current, m\.delegation!\.runId, true\)/);
  ...
  assert.match(screenSource, /const isDelegationToolPreviewExpanded = m\.delegation/);
  assert.match(screenSource, /getChatDisplayExpansionState\(expandedDelegationToolPreviews, m\.delegation\.runId\)/);
  assert.match(screenSource, /const delegationToolPreviewState = delegationCardState\?\.toolPreview \?\? \{ rows: \[\], hiddenCount: 0 \};/);
  assert.match(screenSource, /const delegationVisibleToolRows = delegationToolPreviewState\.rows;/);
  assert.match(screenSource, /const delegationHiddenToolCount = delegationToolPreviewState\.hiddenCount;/);
  assert.match(screenSource, /const delegationToolPreviewMoreAction = getChatRuntimeDelegationToolPreviewMoreActionState\(\s*delegationHiddenToolCount,\s*\);/);
  assert.match(screenSource, /mobileRuntimeDelegationCard\.toolPreviewMaxRows/);
  ...
  assert.match(screenSource, /setExpandedDelegationToolPreviews\(\(current\) =>\s*setChatDisplayExpansionState\(current, m\.delegation!\.runId, true\)/);
...
test('uses shared runtime header copy for mobile stop and hands-free controls', () => {
  ...
  assert.match(screenSource, /const inactiveHeaderPinRenderState = getChatRuntimePinMobileRenderState\(\{\s+isPinned: false,\s+colors: theme\.colors,\s+\}\);/);
  assert.match(screenSource, /const activeHeaderPinRenderState = getChatRuntimePinMobileRenderState\(\{\s+isPinned: true,\s+colors: theme\.colors,\s+\}\);/);
  assert.match(screenSource, /const headerKillSwitchRenderState = getChatRuntimeKillSwitchMobileRenderState\(\{\s+colors: theme\.colors,\s+\}\);/);
  assert.match(screenSource, /headerPinButton:\s*\{[\s\S]*?horizontalPadding:\s*headerSurface\.pinButton\.horizontalPadding/);
  assert.match(screenSource, /headerPinButton:\s*\{[\s\S]*?borderColor:\s*inactiveHeaderPinRenderState\.button\.borderColor,[\s\S]*?backgroundColor:\s*inactiveHeaderPinRenderState\.button\.backgroundColor/);
  assert.match(screenSource, /headerPinButtonActive:\s*\{[\s\S]*?borderColor:\s*activeHeaderPinRenderState\.button\.borderColor,[\s\S]*?backgroundColor:\s*activeHeaderPinRenderState\.button\.backgroundColor/);
  assert.match(screenSource, /headerKillSwitchIconContainer:\s*\{[\s\S]*?width:\s*headerSurface\.killSwitchButton\.size,[\s\S]*?borderRadius:\s*headerSurface\.killSwitchButton\.borderRadius,[\s\S]*?backgroundColor:\s*headerKillSwitchRenderState\.button\.backgroundColor,[\s\S]*?alignItems:\s*headerSurface\.killSwitchButton\.alignItems,[\s\S]*?justifyContent:\s*headerSurface\.killSwitchButton\.justifyContent/);
...
test('uses shared runtime presentation for the mobile chat viewport and loading state', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatConversationHomePromptEditorModal\s+\{\.\.\.promptEditor\}\s+\{\.\.\.promptEditorChrome\}/);
  ...
  assert.match(screenSource, /viewport=\{\{[\s\S]*?loadingState: \{[\s\S]*?renderState: mobileRuntimeLoadingState,[\s\S]*?spinnerSource: isDark \? darkSpinner : lightSpinner,[\s\S]*?\}/);
  assert.match(screenSource, /homeQuickStarts: \{[\s\S]*?shouldRender: !sessionStore\.isLoadingMessages && messages\.length === 0,[\s\S]*?items: promptQuickStarts,[\s\S]*?onPress: handleQuickStartPress,[\s\S]*?onEditPrompt: openEditPromptModal,[\s\S]*?onDeletePrompt: handleDeletePrompt,[\s\S]*?\}/);
  ...
  assert.match(screenSource, /loadingState: \{\s+shouldRender: sessionStore\.isLoadingMessages && messages\.length === 0,\s+renderState: mobileRuntimeLoadingState,\s+accessibilityLabel: mobileRuntimeActivityAccessibility\.loadingMessagesLabel,\s+spinnerSource: isDark \? darkSpinner : lightSpinner,\s+\}/);
...
test('uses shared desktop-style icons for mobile composer controls', () => {
  ...
  assert.match(screenSource, /getChatComposerMobileSurfaceColors,/);
  assert.match(screenSource, /getChatComposerMobileTextColors,/);
  ...
  assert.match(screenSource, /const chatComposerRuntimeDockChrome = useMemo\(\s+\(\) => createChatComposerRuntimeDockChromeProps\(\{\s+composerSurface: mobileComposerSurface,\s+composerTextColors: mobileComposerTextColors,\s+handsFreeSurface: mobileHandsFreeSurface,\s+webAccessibility: mobileComposerWebAccessibility,\s+isWebPlatform,\s+micWebPressedStyle: composerMicWebPressStyle,\s+\}\),\s+\[isWebPlatform, mobileComposerTextColors\],\s+\);/);
  ...
  assert.match(screenSource, /const mobileComposerTextColors = useMemo\(\s+\(\) => getChatComposerMobileTextColors\(theme\.colors\),\s+\[theme\.colors\],\s+\);/);
  ...
  assert.match(screenSource, /editBeforeSendControl: \{\s+shouldRender: !handsFree,\s+renderState: mobileComposerEditBeforeSendRenderState,\s+onPress: \(\) => setWillCancel\(\(current\) => !current\),\s+\.\.\.chatComposerRuntimeDockChrome\.editBeforeSendControl,/);
  ...
  assert.match(screenSource, /queueAction: \{\s+shouldRender: handsFree && messageQueueEnabled,\s+renderState: mobileComposerQueueRenderState,\s+onPress: queueComposerInput,\s+\.\.\.chatComposerRuntimeDockChrome\.queueAction,/);
  ...
  assert.match(screenSource, /const mobileComposerTextColors = getChatComposerMobileTextColors\(theme\.colors\);/);
...
test('keeps the live voice overlay compact by grouping status and transcript into one card', () => {
  ...
  assert.match(screenSource, /voiceOverlay: \{\s+isVisible: listening,\s+label: voiceOverlayLabel,\s+transcript: liveTranscript,\s+transcriptNumberOfLines: mobileComposerSurface\.voiceOverlay\.transcriptNumberOfLines,/);
...
test('derives visible assistant content from respond_to_user output and suppresses raw tool payloads', () => {
  assert.match(screenSource, /getChatMessageDisplayState,/);
  ...
  assert.match(screenSource, /const messageDisplayState = getChatMessageDisplayState\(m, \{\s+resultOnlyToolLabel: toolExecutionResultOnlyFallback\.label,\s+\}\);/);
  ...
  assert.match(screenSource, /if \(!messageDisplayState\.shouldRenderSurface\) \{\s+return null;\s+\}/);
...
test('bases assistant collapse decisions on visible content instead of raw tool payload metadata', () => {
  ...
  assert.match(screenSource, /const effectiveShouldCollapse = messageDisplayState\.shouldCollapse;/);
...
test('uses shared media sanitization for collapsed mobile message previews', () => {
  assert.match(screenSource, /getChatMessageMobileRenderState,/);
  assert.match(screenSource, /content: \{\s+contentState: messageContentRenderState,/);
...
test('derives tool execution card status from displayed non-meta tool entries', () => {
  ...
  assert.match(screenSource, /getToolExecutionDetailMobileBadgeColors,/);
  assert.match(screenSource, /getToolExecutionDetailMobileCollapseControlRenderState,/);
  assert.match(screenSource, /getToolExecutionDetailMobileColors,/);
  assert.match(screenSource, /getToolExecutionDetailMobileContentColors,/);
  assert.match(screenSource, /getToolExecutionDetailMobileCopyButtonColors,/);
  ...
  assert.match(screenSource, /getToolExecutionDetailMobileErrorColors,/);
  ...
  assert.match(screenSource, /getToolExecutionDetailMobilePayloadPreviewColors,/);
  ...
  assert.match(screenSource, /state: toolExecutionState,[\s\S]*?allSuccess,[\s\S]*?hasErrors,[\s\S]*?isPending,[\s\S]*?\} = getToolExecutionSummaryDisplayState\(renderedToolEntries\.map\(entry => entry\.result\)\);/);
  assert.match(screenSource, /const toolExecutionExpandControl = getToolExecutionDetailMobileExpandControlRenderState\(\);/);
  ...
  assert.match(screenSource, /const getToolExecutionDetailColors = \(state: Parameters<typeof getToolExecutionDetailMobileColors>\[0\]\) =>\s+getToolExecutionDetailMobileColors\(state, theme\.colors\);/);
  assert.match(screenSource, /toolExecutionCard:\s*\{[\s\S]*?marginTop:\s*detailedToolExecution\.card\.marginTop,[\s\S]*?\.\.\.getToolExecutionDetailColors\('idle'\)/);
  assert.match(screenSource, /toolExecutionPending:\s*getToolExecutionDetailColors\('pending'\)/);
  assert.match(screenSource, /toolExecutionSuccess:\s*getToolExecutionDetailColors\('success'\)/);
  assert.match(screenSource, /toolExecutionError:\s*getToolExecutionDetailColors\('error'\)/);
  ...
  assert.match(screenSource, /const toolExecutionTopCollapseControl = getToolExecutionDetailMobileCollapseControlRenderState\(\{\s*placement: 'top',\s*toolCallCount: displayToolCallCount,\s*colors: theme\.colors,\s*\}\);/);
  assert.match(screenSource, /const toolExecutionBottomCollapseControl = getToolExecutionDetailMobileCollapseControlRenderState\(\{\s*colors: theme\.colors,\s*\}\);/);
  ...
  assert.match(screenSource, /const toolPayloadPreviewColors = getToolExecutionDetailMobilePayloadPreviewColors\(theme\.colors\);/);
  assert.match(screenSource, /const toolDetailCopyButtonColors = getToolExecutionDetailMobileCopyButtonColors\(theme\.colors\);/);
  assert.match(screenSource, /const toolResultBadgeSuccessColors = getToolExecutionDetailMobileBadgeColors\('success', theme\.colors\);/);
  assert.match(screenSource, /const toolResultBadgeErrorColors = getToolExecutionDetailMobileBadgeColors\('error', theme\.colors\);/);
  assert.match(screenSource, /const toolResultErrorColors = getToolExecutionDetailMobileErrorColors\(theme\.colors\);/);
  assert.match(screenSource, /const toolExecutionDetailContentColors = getToolExecutionDetailMobileContentColors\(theme\.colors\);/);
  ...
  assert.match(screenSource, /const toolInputCopyButtonState = getToolExecutionDetailMobileCopyButtonRenderState\(\{\s+kind: 'input',\s+toolName: toolNameLabel,\s+colors: theme\.colors,\s+\}\);/);
  assert.match(screenSource, /const toolOutputCopyButtonState = getToolExecutionDetailMobileCopyButtonRenderState\(\{\s+kind: 'output',\s+toolName: toolNameLabel,\s+colors: theme\.colors,\s+\}\);/);
  assert.match(screenSource, /const toolErrorCopyButtonState = getToolExecutionDetailMobileCopyButtonRenderState\(\{\s+kind: 'error',\s+toolName: toolNameLabel,\s+colors: theme\.colors,\s+\}\);/);
  assert.match(screenSource, /copyButtonRenderState: toolInputCopyButtonState,/);
  assert.doesNotMatch(screenSource, /<ChatMessageToolExecutionCopyButton\s+renderState=\{toolInputCopyButtonState\}/);
  assert.match(screenSource, /copyButtonRenderState: toolOutputCopyButtonState,/);
  assert.doesNotMatch(screenSource, /<ChatMessageToolExecutionCopyButton\s+renderState=\{toolOutputCopyButtonState\}/);
  assert.match(screenSource, /errorCopyButtonRenderState: toolErrorCopyButtonState,/);
  ...
  assert.match(screenSource, /pendingResult: !result && toolResultDetail\.isPending \? \{\s+renderState: toolExecutionDetailPendingResultState,\s+\} : null,/);
  ...
  assert.match(screenSource, /const toolArgumentsDetail = getToolExecutionDetailArgumentsState\(toolCall\.arguments\);/);
  assert.match(screenSource, /const toolArgumentsPayload = toolArgumentsDetail\.payload;/);
  assert.match(screenSource, /const toolArgumentsText = toolArgumentsDetail\.content;/);
  assert.match(screenSource, /const toolInputHeaderState = getToolExecutionDetailMobileSectionHeaderRenderState\(\{\s+kind: 'input',\s+payload: toolArgumentsPayload,\s+\}\);/);
  assert.match(screenSource, /input: toolArgumentsDetail\.hasArguments \? \{/);
  ...
  assert.match(screenSource, /const toolResultDetail = getToolExecutionDetailResultState\(result\);/);
  assert.match(screenSource, /const toolResultContent = toolResultDetail\.content;/);
  assert.match(screenSource, /const toolResultPayload = toolResultDetail\.payload;/);
  assert.match(screenSource, /const toolResultState = toolResultDetail\.state;/);
  assert.match(screenSource, /const toolOutputHeaderState = getToolExecutionDetailMobileSectionHeaderRenderState\(\{\s+kind: 'output',\s+payload: toolResultPayload,\s+\}\);/);
  assert.match(screenSource, /const toolErrorHeaderState = getToolExecutionDetailMobileSectionHeaderRenderState\(\{\s+kind: 'error',\s+\}\);/);
  ...
  assert.match(screenSource, /const toolDetailHeaderState = getToolExecutionDetailMobileHeaderRenderState\(\{\s+toolName: toolNameLabel,\s+isExpanded: isToolCallFullyExpanded,\s+resultState: toolResultState,\s+colors: theme\.colors,\s+\}\);/);
  ...
  assert.match(screenSource, /const stableMessageKey = m\.id \?\? String\(i\);/);
  assert.match(screenSource, /const toolExecutionDetailRows = renderedToolEntries\.map\(\(\{ toolCall, label, origIdx, result \}\) => \{/);
  assert.match(screenSource, /key: toolCallKey,[\s\S]*?renderState: toolDetailHeaderState,[\s\S]*?toolName: toolNameLabel,[\s\S]*?onHeaderPress: \(\) => toggleToolCallExpansion\(stableMessageKey, origIdx\),/);
  assert.match(screenSource, /detailRows: toolExecutionDetailRows/);
  ...
  assert.match(screenSource, /result: result \? \{\s+payloadRenderState: toolOutputHeaderState,\s+resultBadge: toolDetailHeaderState\.resultBadge,\s+characterCountLabel: toolResultDetail\.characterCountLabel,\s+resultCompactText: toolResultPayload\?\.compactText,\s+resultContent: toolResultContent,/);
  assert.match(screenSource, /copyButtonRenderState: toolOutputCopyButtonState,\s+onCopyPress: \(\) => \{ void handleCopyToolPayload\(toolResultContent\); \},\s+errorRenderState: toolErrorHeaderState,\s+error: toolResultDetail\.error,\s+errorCopyButtonRenderState: toolErrorCopyButtonState,/);
  ...
  assert.match(screenSource, /topCollapseRenderState: toolExecutionTopCollapseControl,/);
  ...
  assert.match(screenSource, /handleCopyToolPayload\(toolArgumentsText\)/);
  assert.match(screenSource, /handleCopyToolPayload\(toolResultContent\)/);
  assert.match(screenSource, /handleCopyToolPayload\(toolResultDetail\.error \?\? ''\)/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{renderState\.accessibilityRole\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{renderState\.accessibilityLabel\}/);
  ...
  assert.match(screenSource, /characterCountLabel: toolResultDetail\.characterCountLabel,/);
...
test('uses shared runtime activity copy for mobile loading and thinking states', () => {
  ...
  assert.match(screenSource, /const mobileRuntimeActivityAccessibility = getChatRuntimeMobileActivityAccessibilityState\(\);/);
  assert.match(screenSource, /accessibilityLabel: mobileRuntimeActivityAccessibility\.loadingMessagesLabel/);
  assert.match(screenSource, /accessibilityLabel: mobileRuntimeActivityAccessibility\.thinkingLabel/);
  ...
  assert.match(screenSource, /inlineActivity: m\.role === 'assistant' && \(!m\.content \|\| m\.content\.length === 0\) && !m\.toolCalls && !m\.toolResults \? \{[\s\S]*?renderState: mobileRuntimeInlineActivity,[\s\S]*?accessibilityLabel: mobileRuntimeActivityAccessibility\.thinkingLabel,[\s\S]*?spinnerSource: isDark \? darkSpinner : lightSpinner,/);
...
test('uses desktop-style streaming response chrome while mobile assistant content is live', () => {
  ...
  assert.match(screenSource, /isChatMessageLiveStreamingConversationContent,/);
  ...
  assert.match(screenSource, /const isLiveStreamingAssistantMessage = isChatMessageLiveStreamingConversationContent\(\{\s+isResponding: responding,\s+messageIndex: i,\s+lastConversationContentMessageIndex: lastAssistantContentMessageIndex,\s+message: m,\s+content: visibleMessageContent,\s+displayToolCallCount,\s+\}\);/);
...
test('uses shared message queue surface tokens for the chat-adjacent queue wrapper', () => {
  assert.match(screenSource, /getMessageQueuePanelMobileSurfaceState,/);
  assert.match(screenSource, /from '@dotagents\/shared\/message-queue-utils'/);
  assert.match(screenSource, /const mobileMessageQueuePanelSurface = getMessageQueuePanelMobileSurfaceState\(\);/);
  assert.match(screenSource, /const messageQueuePanelSurface = mobileMessageQueuePanelSurface;/);
...
test('uses tool activities wording consistently for grouped tool activity labels', () => {
  ...
  assert.match(screenSource, /const chatMessageRuntimeThreadStyles = useMemo\(\s+\(\) => createChatMessageRuntimeThreadStyleSlots\(\{\s+threadSurfaceStyles: messageThreadSurfaceStyles,\s+threadBodyStyles: messageThreadBodyStyles,\s+\}\),\s+\[messageThreadSurfaceStyles, messageThreadBodyStyles\],\s+\);/);
  ...
  assert.match(screenSource, /if \(groupRenderState\?\.shouldSkipCollapsedItem \|\| groupRenderState\?\.shouldRenderCollapsedHeader\) \{/);
  assert.match(screenSource, /<ChatMessageRuntimeThread\s+key=\{groupRenderState\.shouldRenderCollapsedHeader \? `group-\$\{groupRenderState\.groupKey\}` : i\}\s+groupRenderState=\{groupRenderState\}\s+onToggleGroup=\{group \? \(\) => toggleGroupExpansion\(group\) : undefined\}\s+body=\{null\}\s+styles=\{chatMessageRuntimeThreadStyles\}/);
  ...
  assert.match(screenSource, /<ChatMessageRuntimeThread\s+key=\{i\}\s+surfaceToneStyle=\{messageToneStyle\}\s+groupRenderState=\{groupRenderState\}\s+onToggleGroup=\{group \? \(\) => toggleGroupExpansion\(group\) : undefined\}\s+styles=\{chatMessageRuntimeThreadStyles\}\s+body=\{\{/);
...
test('keeps the TTS control inline with assistant message text instead of on a detached row', () => {
  ...
  assert.match(screenSource, /import \{[\s\S]*?ChatMessageRuntimeThread,[\s\S]*?createChatMessageActionSet,[\s\S]*?createChatMessageRuntimeThreadStyleSlots,[\s\S]*?createChatMessageToolActivityGroupThreadSurfaceStyleSlots,[\s\S]*?\} from '\.\.\/ui\/ChatMessageChrome';/);
  ...
  assert.match(screenSource, /getChatMessageActionMobileButtonColors,/);
  assert.match(screenSource, /getChatMessageActionMobileButtonState,/);
  assert.match(screenSource, /getChatMessageActionMobileRowState,/);
  assert.match(screenSource, /getChatRuntimeTurnDurationMessageMobileRenderState,/);
  assert.match(screenSource, /getChatMessageCopyMobileRenderState,/);
  assert.match(screenSource, /getChatMessageExpansionMobileRenderState,/);
  assert.match(screenSource, /getChatMessageMobileRenderState,/);
  assert.match(screenSource, /getChatMessageSpeechMobileRenderState,/);
  ...
  assert.match(screenSource, /body=\{\{[\s\S]*?conversation: \{[\s\S]*?content: \{[\s\S]*?slots: messageActionSet\.visibleSlots,[\s\S]*?components: messageActionSet\.components,/);
  ...
  assert.equal((screenSource.match(/slots: messageActionSet\.visibleSlots/g) ?? []).length, 2);
  assert.equal((screenSource.match(/components: messageActionSet\.components/g) ?? []).length, 2);
  ...
  assert.match(screenSource, /content: \{\s+contentState: messageContentRenderState,\s+slots: messageActionSet\.visibleSlots,\s+components: messageActionSet\.components/);
  ...
  assert.match(screenSource, /onPress: \(\) => speakMessage\(i, visibleMessageContent\)/);
  ...
  assert.match(screenSource, /const mobileMessageActionRow = getChatMessageActionMobileRowState\(\);/);
  assert.match(screenSource, /const mobileMessageActionButton = getChatMessageActionMobileButtonState\(\);/);
  assert.match(screenSource, /const mobileMessageBranchButton = getChatMessageActionMobileButtonState\('branch'\);/);
  assert.match(screenSource, /const mobileMessageCopiedButton = getChatMessageActionMobileButtonState\('copied'\);/);
  assert.match(screenSource, /const mobileMessageSpeechButton = getChatMessageActionMobileButtonState\('speech'\);/);
  assert.match(screenSource, /const mobileMessageSpeechActiveButton = getChatMessageActionMobileButtonState\('speechActive'\);/);
  assert.match(screenSource, /const mobileMessageActionButtonColors = getChatMessageActionMobileButtonColors\('standard', theme\.colors\);/);
  assert.match(screenSource, /const mobileMessageBranchButtonColors = getChatMessageActionMobileButtonColors\('branch', theme\.colors\);/);
  assert.match(screenSource, /const mobileMessageCopiedButtonColors = getChatMessageActionMobileButtonColors\('copied', theme\.colors\);/);
  assert.match(screenSource, /const mobileMessageSpeechButtonColors = getChatMessageActionMobileButtonColors\('speech', theme\.colors\);/);
  assert.match(screenSource, /const mobileMessageSpeechActiveButtonColors = getChatMessageActionMobileButtonColors\('speechActive', theme\.colors\);/);
  ...
  assert.equal((screenSource.match(/renderState: message(?:Expansion|Branch|Copy)RenderState/g) ?? []).length, 3);
  ...
  assert.match(screenSource, /renderState: messageExpansionRenderState,/);
  ...
  assert.equal((screenSource.match(/accessibilityLabel=\{messageExpansionRenderState\.accessibilityLabel\}/g) ?? []).length, 0);
  assert.match(screenSource, /accessibilityLabel: messageExpansionRenderState\.accessibilityLabel/);
...
test('shows shared per-turn duration badges on mobile user messages', () => {
  ...
  assert.match(screenSource, /const messageTurnDurationRenderState = getChatRuntimeTurnDurationMessageMobileRenderState\(\{\s+role: m\.role,\s+durationMs: turnDurationEntry\?\.durationMs,\s+isLive: turnDurationEntry\?\.isLive,\s+colors: theme\.colors,\s+\}\);/);
...
test('uses shared desktop chat message presentation tones for mobile message cards', () => {
  ...
  assert.match(screenSource, /const messageRenderState = getChatMessageMobileRenderState\(\{\s+role: m\.role,\s+isComplete: !responding,/);
  assert.match(screenSource, /isLast: i === lastAssistantContentMessageIndex,/);
  assert.match(screenSource, /hasErrors,\s+content: visibleMessageContent,\s+isExpanded,\s+shouldCollapse: effectiveShouldCollapse,\s+isLiveStreaming: isLiveStreamingAssistantMessage,\s+colors: theme\.colors,/);
  assert.match(screenSource, /const messageContentRenderState = messageRenderState\.content;/);
  ...
  assert.match(screenSource, /accessibilityState: messageExpansionRenderState\.accessibilityState/);
  assert.equal((screenSource.match(/ariaExpanded=\{messageExpansionRenderState\.ariaExpanded\}/g) ?? []).length, 0);
  assert.match(screenSource, /ariaExpanded: messageExpansionRenderState\.ariaExpanded/);
  assert.equal((screenSource.match(/aria-expanded=\{messageExpansionRenderState\.ariaExpanded\}/g) ?? []).length, 0);
...
test('replaces the empty mobile chat home state with quick-start launchers', () => {
  assert.match(screenSource, /homeQuickStarts: \{[\s\S]*?shouldRender: !sessionStore\.isLoadingMessages && messages\.length === 0,[\s\S]*?items: promptQuickStarts,[\s\S]*?onPress: handleQuickStartPress,[\s\S]*?onEditPrompt: openEditPromptModal,[\s\S]*?onDeletePrompt: handleDeletePrompt,/);
  ...
  assert.match(screenSource, /const promptLibraryEditorCloseIconColors = useMemo\(\s+\(\) => getPromptLibraryMobileIconColors\(promptLibraryEditorCloseIcon, theme\.colors\),\s+\[theme\.colors\],\s+\);/);
  ...
  assert.match(screenSource, /shortcutActionAccessibilityRole: mobilePromptLibrarySurface\.shortcutActionButton\.accessibilityRole/);
  assert.match(screenSource, /sourceLabelNumberOfLines: mobilePromptLibrarySurface\.shortcutSourceLabel\.numberOfLines/);
  assert.match(screenSource, /titleNumberOfLines: mobilePromptLibrarySurface\.shortcutTitle\.numberOfLines/);
  assert.match(screenSource, /descriptionNumberOfLines: mobilePromptLibrarySurface\.shortcutDescription\.numberOfLines/);
  ...
  assert.match(chatMessageChromeSource, /shortcutChrome: PromptLibraryMobileShortcutChromeState;/);
  ...
  assert.match(chatMessageChromeSource, /accessibilityRole=\{shortcutCardAccessibilityRole\}/);
  assert.match(chatMessageChromeSource, /numberOfLines=\{titleNumberOfLines\}/);
  assert.match(chatMessageChromeSource, /numberOfLines=\{sourceLabelNumberOfLines\}/);
  assert.match(chatMessageChromeSource, /numberOfLines=\{descriptionNumberOfLines\}/);
  assert.match(chatMessageChromeSource, /\{isLoading \? loadingLabel : emptyLabel\}/);
  ...
  assert.match(chatMessageChromeSource, /accessibilityRole=\{shortcutActionAccessibilityRole\}/);
...
test('lets mobile edit and delete desktop saved prompts from quick-start cards', () => {
  ...
  assert.match(chatMessageChromeSource, /getPromptLibraryDeletePromptAccessibilityLabel\(item\.title\)/);
  ...
  assert.match(screenSource, /const promptEditorModalSurface = mobilePromptLibrarySurface\.editorModal/);
  assert.match(screenSource, /const promptEditorModalChrome = useMemo\(\s+\(\) => createChatConversationHomePromptEditorModalChromeProps\(\{\s+surface: promptEditorModalSurface,\s+colors: promptLibrarySurfaceColors\.editorModal,\s+keyboardAvoidingBehavior: promptEditorKeyboardAvoidingBehavior,\s+closeIcon: promptLibraryEditorCloseIcon,\s+closeIconColors: promptLibraryEditorCloseIconColors,\s+closeButtonAccessibilityLabel: promptLibraryCopy\.editor\.closeAccessibilityLabel,\s+styles: promptEditorModalStyles,\s+\}\),/);
  assert.match(screenSource, /promptEditorChrome: promptEditorModalChrome/);
  assert.doesNotMatch(screenSource, /promptEditorChrome: \{[\s\S]*?modalTransparent:/);
  assert.match(chatMessageChromeSource, /export function createChatConversationHomePromptEditorModalChromeProps/);
  assert.match(chatMessageChromeSource, /modalTransparent: surface\.modal\.transparent/);
  assert.match(chatMessageChromeSource, /modalAnimationType: surface\.modal\.animationType/);
  assert.match(screenSource, /const promptEditorKeyboardAvoidingBehavior = getPromptLibraryEditorModalKeyboardAvoidingBehavior\(Platform\.OS\);/);
  assert.match(screenSource, /keyboardAvoidingBehavior: promptEditorKeyboardAvoidingBehavior/);
  assert.match(screenSource, /closeIcon: promptLibraryEditorCloseIcon/);
  assert.match(screenSource, /closeIconColors: promptLibraryEditorCloseIconColors/);
  assert.match(chatMessageChromeSource, /closeButtonPressedOpacity: surface\.closeButton\.pressedOpacity/);
  assert.match(chatMessageChromeSource, /closeButtonAccessibilityRole: surface\.closeButton\.accessibilityRole/);
  assert.match(screenSource, /closeButtonAccessibilityLabel: promptLibraryCopy\.editor\.closeAccessibilityLabel/);
  assert.match(chatMessageChromeSource, /transparent=\{modalTransparent\}/);
  assert.match(chatMessageChromeSource, /animationType=\{modalAnimationType\}/);
  ...
  assert.match(chatMessageChromeSource, /accessibilityRole=\{closeButtonAccessibilityRole\}/);
  ...
  assert.match(chatMessageChromeSource, /multilineInputMultiline: surface\.multilineInput\.multiline/);
  assert.match(chatMessageChromeSource, /multilineInputTextAlignVertical: surface\.multilineInput\.textAlignVertical/);
  assert.match(chatMessageChromeSource, /placeholderTextColor=\{inputPlaceholderTextColor\}/);
  assert.match(chatMessageChromeSource, /multiline=\{multilineInputMultiline\}/);
  assert.match(chatMessageChromeSource, /textAlignVertical=\{multilineInputTextAlignVertical\}/);
  ...
  assert.match(chatMessageChromeSource, /cancelButtonPressedOpacity: surface\.cancelButton\.pressedOpacity/);
  assert.match(chatMessageChromeSource, /cancelButtonAccessibilityRole: surface\.cancelButton\.accessibilityRole/);
  assert.match(chatMessageChromeSource, /activeOpacity=\{cancelButtonPressedOpacity\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{cancelButtonAccessibilityRole\}/);
  ...
  assert.match(chatMessageChromeSource, /saveButtonPressedOpacity: surface\.saveButton\.pressedOpacity/);
  assert.match(chatMessageChromeSource, /saveButtonAccessibilityRole: surface\.saveButton\.accessibilityRole/);
  assert.match(chatMessageChromeSource, /activeOpacity=\{saveButtonPressedOpacity\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{saveButtonAccessibilityRole\}/);
