...
- **[Skills](skills.md)** — Teach agents specialized knowledge
- **[Memory](memory.md)** — Give agents persistent context
- **[Multi-Agent Delegation](delegation.md)** — Set up agent coordination
- **[MCP Tools](../tools/mcp.md)** — Configure available tools
