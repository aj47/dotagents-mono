...
test('lets mobile edit and delete desktop saved prompts from quick-start cards', () => {
  ...
  assert.match(screenSource, /const promptEditorModalChrome = useMemo\(\s+\(\) => createChatConversationHomePromptEditorModalChromeProps\(\{\s+renderState: promptLibraryEditorRenderState,\s+styles: promptEditorModalStyles,\s+\}\),/);
  ...
  assert.match(chatMessageChromeSource, /closeButtonAccessibilityLabel: copy\.closeAccessibilityLabel/);
  ...
  assert.match(chatMessageChromeSource, /editorChrome: PromptLibraryEditorMobileRenderState\['chrome'\];/);
