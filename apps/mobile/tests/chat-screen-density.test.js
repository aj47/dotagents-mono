...
test('renders delegated agent progress as compact desktop-style mobile chrome', () => {
  ...
  assert.match(delegationCardComponentSource, /style=\{row\.role\.style\}/);
  assert.match(delegationCardComponentSource, /numberOfLines=\{row\.role\.numberOfLines\}/);
  assert.match(delegationCardComponentSource, /ellipsizeMode=\{row\.role\.ellipsizeMode\}/);
  assert.match(delegationCardComponentSource, /style=\{row\.content\.style\}/);
  assert.match(delegationCardComponentSource, /numberOfLines=\{row\.content\.numberOfLines\}/);
  assert.match(delegationCardComponentSource, /ellipsizeMode=\{row\.content\.ellipsizeMode\}/);
...
test('uses shared media sanitization for collapsed mobile message previews', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageCollapsedPreview\s+\{\.\.\.conversationContentParts\.collapsedContent\.preview\}/);
...
test('derives tool execution card status from displayed non-meta tool entries', () => {
  ...
  assert.match(sessionPresentationSource, /rows: rows\.map\(\(row\) => \(\{/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionCompactRow\s+key=\{row\.key\}\s+renderState=\{row\.renderState\}\s+styles=\{row\.styles\}/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionExpandedGroup \{\.\.\.panelParts\.expandedGroup\}>[\s\S]*?\{children\}/);
  ...
  assert.match(chatMessageChromeSource, /callDetailParts\.pendingResult \? \([\s\S]*?<ChatMessageToolExecutionPendingResult\s+\{\.\.\.callDetailParts\.pendingResult\}/);
  assert.match(sessionPresentationSource, /pendingResult: !resultSection && pendingResult \? \{\s+renderState: pendingResult\.renderState,\s+styles: styles\.pendingResult,/);
  ...
  assert.match(chatMessageChromeSource, /callDetailParts\.resultSection \? \([\s\S]*?<ChatMessageToolExecutionResultSection\s+\{\.\.\.callDetailParts\.resultSection\}/);
  assert.match(sessionPresentationSource, /const resultSection = result \? \{\s+\.\.\.result,\s+styles: styles\.resultSection,/);
  ...
  assert.match(chatMessageChromeSource, /resultSectionParts\.errorBlock \? \([\s\S]*?<ChatMessageToolExecutionErrorBlock\s+\{\.\.\.resultSectionParts\.errorBlock\}/);
  ...
  assert.match(sessionPresentationSource, /errorBlock: error \? \{\s+renderState: errorRenderState,\s+error,\s+copyButtonRenderState: errorCopyButtonRenderState,\s+onCopyPress: onErrorCopyPress,\s+styles: styles\.errorBlock,/);
  ...
  assert.match(chatMessageChromeSource, /callDetailParts\.inputSection \? \([\s\S]*?<ChatMessageToolExecutionPayloadSection\s+\{\.\.\.callDetailParts\.inputSection\}/);
  assert.match(sessionPresentationSource, /const inputSection = input \? \{\s+\.\.\.input,\s+styles: styles\.payloadSection,/);
...
test('uses desktop-style streaming response chrome while mobile assistant content is live', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageExpandedContent\s+\{\.\.\.conversationContentParts\.expandedContent\.content\}/);
...
test('uses shared message queue surface tokens for the chat-adjacent queue wrapper', () => {
  ...
  assert.match(messageQueuePanelSource, /item\.separator && <View style=\{item\.separator\.style\} \/>/);
...
test('keeps the TTS control inline with assistant message text instead of on a detached row', () => {
  ...
  assert.match(contentRowSource, /<View style=\{contentRowParts\.row\.style\}>[\s\S]*?contentRowParts\.body \? \(/);
  ...
  assert.match(standaloneActionsSource, /if \(!standaloneActionsParts\.actionSlotList\) return null;/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageRetryStatus\s+\{\.\.\.threadBodyParts\.retryStatus\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageDelegationCard\s+\{\.\.\.threadBodyParts\.delegationCard\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageToolApproval\s+\{\.\.\.threadBodyParts\.toolApproval\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageInlineActivity\s+\{\.\.\.threadBodyParts\.inlineActivity\}/);
  assert.match(sessionPresentationSource, /retryStatus: retryStatus \? \{\s+\.\.\.retryStatus,\s+styles: styles\.retryStatus,/);
  assert.match(sessionPresentationSource, /delegationCard: delegationCard \? \{\s+\.\.\.delegationCard,\s+styles: styles\.delegationCard,/);
  assert.match(sessionPresentationSource, /toolApproval: toolApproval \? \{\s+\.\.\.toolApproval,\s+styles: styles\.toolApproval,/);
  assert.match(sessionPresentationSource, /inlineActivity: inlineActivity \? \{\s+\.\.\.inlineActivity,\s+style: styles\.inlineActivity\.style,\s+spinnerStyle: styles\.inlineActivity\.spinnerStyle,/);
  ...
  assert.match(chatMessageChromeSource, /if \(threadBodyParts\.retryStatus\) \{/);
  assert.match(chatMessageChromeSource, /if \(threadBodyParts\.delegationCard\) \{/);
  assert.match(chatMessageChromeSource, /if \(threadBodyParts\.toolApproval\) \{/);
  assert.match(chatMessageChromeSource, /if \(threadBodyParts\.inlineActivity\) \{/);
  assert.match(sessionPresentationSource, /conversation: createChatRuntimeConversationBodyMobileProps\(\{/);
  ...
  assert.match(sessionPresentationSource, /expandedContent: contentDisplayMode === "expanded" \? \{/);
  assert.match(sessionPresentationSource, /collapsedContent: contentDisplayMode === "collapsed" \? \{/);
  assert.match(chatMessageChromeSource, /if \(conversationContentParts\.expandedContent\) \{/);
  assert.match(chatMessageChromeSource, /if \(conversationContentParts\.collapsedContent\) \{/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageContentRow\s+\{\.\.\.conversationContentParts\.expandedContent\.row\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageExpandedContent\s+\{\.\.\.conversationContentParts\.expandedContent\.content\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageContentRow\s+\{\.\.\.conversationContentParts\.collapsedContent\.row\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageCollapsedPreview\s+\{\.\.\.conversationContentParts\.collapsedContent\.preview\}/);
