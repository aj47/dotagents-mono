...
export function useChatRuntimeSessionStoreState(): ChatRuntimeSessionStoreState {
...
type ChatMessageRuntimeDockStyleSlots =
  ChatRuntimeMobileChromeSlots['surface']['runtimeSurface']['props']['styles']['dock'];
...
type ChatMessageRuntimeSurfaceStyleSlots =
  ChatRuntimeMobileChromeSlots['surface']['runtimeSurface']['props']['styles'];
...
type ChatMessageRuntimeComposerInputStateInput<
  TPrompt extends PredefinedPromptSummary,
  TTask extends PromptLibraryTaskLike & { id: string; name: string },
> = ChatMessageRuntimeChromePropsInput<TPrompt, TTask>['composer'];
...
export function useChatMessageRuntimeComposerInputState<
  TPrompt extends PredefinedPromptSummary,
  TTask extends PromptLibraryTaskLike & { id: string; name: string },
>({
  speechPreviewText,
  ...
  onMicPress,
  micWrapperRef,
}: ChatMessageRuntimeComposerInputStateInput<TPrompt, TTask>): ChatMessageRuntimeComposerInputStateInput<TPrompt, TTask> {
  const chatMessageRuntimeComposerInputState = useMemo<ChatMessageRuntimeComposerInputStateInput<TPrompt, TTask>>(
    () => ({
      speechPreviewText,
      pendingImages,
      onRemovePendingImage,
  ...
  return chatMessageRuntimeComposerInputState;
}
