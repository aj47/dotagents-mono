...
describe("remote-server route registration", () => {
  ...
  it("routes mobile chat requests through the shared agent runner", () => {
    ...
    expect(chatCompletionActionsSource).toContain("validateChatCompletionRequestBody(body, {")
    expect(chatCompletionActionsSource).toContain("validateConversationId: getConversationIdValidationError")
    expect(chatCompletionActionsSource).toContain("return reply.code(validatedRequest.statusCode).send(validatedRequest.body)")
    expect(sharedChatUtilsSource).toContain("export function buildChatCompletionPushNotificationPlan(")
    expect(chatCompletionActionsSource).toContain("buildChatCompletionPushNotificationPlan({")
    ...
    expect(chatCompletionActionsSource).toContain("sendMessageNotification(")
    expect(chatCompletionActionsSource).toContain("notificationPlan.conversationTitle")
  ...
  it("registers note-only knowledge routes", () => {
    ...
    expect(knowledgeNoteActionsSource).toContain("getKnowledgeNotesAction(query, knowledgeNoteActionOptions)")
    expect(knowledgeNoteActionsSource).toContain("getKnowledgeNoteAction(id, knowledgeNoteActionOptions)")
    expect(knowledgeNoteActionsSource).toContain("searchKnowledgeNotesAction(body, knowledgeNoteActionOptions)")
    expect(knowledgeNoteActionsSource).toContain("deleteMultipleKnowledgeNotesAction(body, knowledgeNoteActionOptions)")
    expect(knowledgeNoteActionsSource).toContain("deleteAllKnowledgeNotesAction(knowledgeNoteActionOptions)")
