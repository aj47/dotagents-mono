...
export function buildSettingsResponse(
  ...
  return {
    ...
    floatingPanelAutoShow: cfg.floatingPanelAutoShow ?? DEFAULT_FLOATING_PANEL_AUTO_SHOW,
    hidePanelWhenMainFocused: cfg.hidePanelWhenMainFocused ?? DEFAULT_HIDE_PANEL_WHEN_MAIN_FOCUSED,
    hideDockIcon: cfg.hideDockIcon ?? DEFAULT_HIDE_DOCK_ICON,
    launchAtLogin: cfg.launchAtLogin ?? DEFAULT_LAUNCH_AT_LOGIN,
    panelPosition: cfg.panelPosition ?? DEFAULT_PANEL_POSITION,
    panelCustomPosition: cfg.panelCustomPosition,
    panelDragEnabled: cfg.panelDragEnabled ?? DEFAULT_PANEL_DRAG_ENABLED,
    ...
    ttsAutoPlay: cfg.ttsAutoPlay ?? DEFAULT_TTS_AUTO_PLAY,
    ttsPreprocessingEnabled: cfg.ttsPreprocessingEnabled ?? DEFAULT_TTS_PREPROCESSING_ENABLED,
    ttsRemoveCodeBlocks: cfg.ttsRemoveCodeBlocks ?? DEFAULT_TTS_REMOVE_CODE_BLOCKS,
    ttsRemoveUrls: cfg.ttsRemoveUrls ?? DEFAULT_TTS_REMOVE_URLS,
    ttsConvertMarkdown: cfg.ttsConvertMarkdown ?? DEFAULT_TTS_CONVERT_MARKDOWN,
    ttsUseLLMPreprocessing: cfg.ttsUseLLMPreprocessing ?? DEFAULT_TTS_USE_LLM_PREPROCESSING,
    ...
    remoteServerCorsOrigins: cfg.remoteServerCorsOrigins ?? getDefaultRemoteServerCorsOrigins(),
    remoteServerOperatorAllowDeviceIds: cfg.remoteServerOperatorAllowDeviceIds ?? [],
    remoteServerAutoShowPanel: cfg.remoteServerAutoShowPanel ?? DEFAULT_REMOTE_SERVER_AUTO_SHOW_PANEL,
    remoteServerTerminalQrEnabled: cfg.remoteServerTerminalQrEnabled ?? DEFAULT_REMOTE_SERVER_TERMINAL_QR_ENABLED,
    cloudflareTunnelMode: cfg.cloudflareTunnelMode ?? DEFAULT_CLOUDFLARE_TUNNEL_MODE,
    cloudflareTunnelAutoStart: cfg.cloudflareTunnelAutoStart ?? DEFAULT_CLOUDFLARE_TUNNEL_AUTO_START,
