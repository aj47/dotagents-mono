...
test('uses desktop-style streaming response chrome while mobile assistant content is live', () => {
  ...
  assert.match(videoAttachmentCardSource, /const videoAttachmentParts = createChatVideoAttachmentMobilePropsParts\(\{\s+renderState: videoAttachmentRenderState,\s+styles,\s+isLoading: loading,\s+canOpenExternally,\s+loadError,\s+onLoadVideo: loadVideo,\s+onOpenVideo: openVideo,\s+\}\);/);
