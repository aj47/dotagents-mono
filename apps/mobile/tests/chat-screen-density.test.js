...
test('resolves mobile monospace typography from shared surface tokens', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /createChatRuntimeTurnDurationMessageMobileStyleSlotVariants,/);
  ...
  assert.match(screenSource, /const mobileMessageTurnDurationStyleSlots = createChatRuntimeTurnDurationMessageMobileStyleSlotVariants\(\{\s+renderState: mobileMessageThreadStyleState\.turnDuration,\s+platform: mobilePlatform,\s+\}\);/);
...
test('keeps agent selection in the navigation header for the mobile chat screen', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /const chatRuntimeHeaderStyles = useMemo\(\s+\(\) => createChatRuntimeHeaderStyleSlotsFromStyleSource\(\{\s+styles: styles as ReturnType<typeof createChatRuntimeMobileStyles>,\s+\}\),\s+\[styles\],\s+\);/);
...
test('uses shared runtime presentation for mobile scroll-to-bottom affordance', () => {
  ...
  assert.match(screenSource, /createChatMessageConversationDockStyleSlotsFromStyleSource,/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /createChatMessageConversationDockStyleSlotsFromStyleSource,[\s\S]*?createChatMessageRuntimeDockStyleSlots,[\s\S]*?\} from '@dotagents\/shared\/session-presentation';/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /const conversationDockStyles = useMemo\(\s+\(\) => createChatMessageConversationDockStyleSlotsFromStyleSource\(\{\s+styles: styles as ReturnType<typeof createChatRuntimeMobileStyles>,\s+\}\),\s+\[styles\],\s+\);/);
...
test('uses shared runtime presentation for the mobile chat viewport and loading state', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /const conversationViewportStyles = useMemo\(\s+\(\) => createChatMessageConversationViewportStyleSlotsFromStyleSource\(\{\s+styles: styles as ReturnType<typeof createChatRuntimeMobileStyles>,\s+\}\),\s+\[styles\],\s+\);/);
...
test('uses shared desktop-style icons for mobile composer controls', () => {
  ...
  assert.match(screenSource, /createChatComposerStyleSlotsFromStyleSource,/);
  assert.match(screenSource, /createChatComposerRuntimeDockStyleSlots,/);
  assert.match(chatRuntimeMobileStylesSource, /createChatComposerStyleSlotsFromStyleSource,[\s\S]*?\} from '@dotagents\/shared\/session-presentation';/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /const chatComposerStyles = useMemo\(\s+\(\) => createChatComposerStyleSlotsFromStyleSource\(\{\s+styles: styles as ReturnType<typeof createChatRuntimeMobileStyles>,\s+\}\),\s+\[styles\],\s+\);/);
...
test('uses shared runtime activity copy for mobile loading and thinking states', () => {
  ...
  assert.match(chatMessageChromeSource, /const conversationThreadListState = getChatRuntimeConversationRuntimeThreadListMobileState\(\{\s+messages: threadListMessages,\s+visibleMessageCount: threadListVisibleMessageCount,[\s\S]*?createThreadState: \(itemState\) => createChatMessageConversationItemThreadState\(\{/);
...
test('uses tool activities wording consistently for grouped tool activity labels', () => {
  ...
  assert.match(chatMessageChromeSource, /function createChatMessageConversationMessageThreadState\(\{/);
  assert.match(chatMessageChromeSource, /function createChatMessageConversationItemThreadState\(\{/);
  ...
  assert.match(chatMessageChromeSource, /return getChatRuntimeConversationItemThreadMobileState\(\{\s+messageThreadInput,\s+createMessageThreadState: createChatMessageConversationMessageThreadState,/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /const chatMessageConversationThreadStyles = useMemo\(\s+\(\) => createChatMessageConversationThreadStyleSlotsFromStyleSource</);
  assert.match(chatRuntimeMobileStylesSource, /styles: styles as ReturnType<typeof createChatRuntimeMobileStyles>,\s+getToneStyle: \(toneStyleSlot\) => styles\[toneStyleSlot\],/);
  ...
  assert.match(chatMessageChromeSource, /const resolvedBody = createChatMessageThreadBodyProps\(runtimeThreadParts\.bodySurface\.body\);/);
...
test('keeps the TTS control inline with assistant message text instead of on a detached row', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /createChatMessageConversationThreadStyleSlotsFromStyleSource,/);
  assert.doesNotMatch(screenSource, /createChatMessageConversationThreadPresentationState,/);
  assert.doesNotMatch(screenSource, /ChatMessageConversationRuntimeThreadList,/);
  ...
  const actionIconButtonSource =
    chatMessageChromeSource.match(/export function ChatMessageActionIconButton[\s\S]*?function createChatMessageConversationMessageThreadState/)?.[0] ?? '';
  ...
  assert.match(chatMessageChromeSource, /const conversationThreadListState = getChatRuntimeConversationRuntimeThreadListMobileState\(\{\s+messages: threadListMessages,\s+visibleMessageCount: threadListVisibleMessageCount,[\s\S]*?createThreadState: \(itemState\) => createChatMessageConversationItemThreadState\(\{/);
  assert.doesNotMatch(screenSource, /createChatMessageConversationThreadPresentationState,/);
  assert.match(screenSource, /createChatMessageConversationThreadStyleSlotsFromStyleSource,/);
  ...
  assert.match(screenSource, /createChatRuntimeMessageActionMobileStyleSlots,/);
  assert.match(screenSource, /const mobileMessageActionStyleSlots = createChatRuntimeMessageActionMobileStyleSlots\(\{\s+renderState: mobileMessageActionStyleState,\s+spacing,\s+\}\);/);
...
test('lets mobile edit and delete desktop saved prompts from quick-start cards', () => {
  ...
  assert.match(screenSource, /createChatConversationHomePromptEditorModalStyleSlotsFromStyleSource,/);
  assert.match(screenSource, /const promptEditorModalStyles = useMemo\(\s+\(\) => createChatConversationHomePromptEditorModalStyleSlotsFromStyleSource\(\{\s+styles: styles as ReturnType<typeof createChatRuntimeMobileStyles>,\s+\}\),\s+\[styles\],\s+\);/);
  assert.match(chatScreenSource, /\.\.\.chatRuntimeChrome\.messageRuntime,/);
