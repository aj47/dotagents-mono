...
describe("remote-server route registration", () => {
  ...
  it("routes mobile chat requests through the shared agent runner", () => {
    ...
    expect(sharedAgentRunUtilsSource).toContain("export function getRemoteAgentConversationMessages")
    expect(sharedAgentRunUtilsSource).toContain("export function buildPreviousConversationHistoryForAgentRun")
    expect(sharedAgentRunUtilsSource).toContain("formatConversationHistoryForApi(getRemoteAgentConversationMessages(latestConversation))")
    ...
    expect(agentLoopRunnerSource).toContain("buildPreviousConversationHistoryForAgentRun(replayMessages)")
  ...
  it("delegates conversation sync and media routes to conversation actions", () => {
    ...
    expect(sharedConversationSyncSource).toContain("export function upsertServerConversationHistoryIndex")
    expect(sharedConversationSyncSource).toContain("export function removeServerConversationHistoryIndexItem")
    expect(sharedConversationSyncSource).toContain("export function normalizeServerConversationHistoryIndex")
    expect(sharedConversationSyncSource).toContain("export function parseServerConversationHistoryIndexData")
    ...
    expect(sharedConversationSyncSource).toContain("export function isServerConversationCompactionSummaryLikelyFailed")
    ...
    expect(sharedConversationSyncSource).toContain("export function parseServerConversationStorageData")
    expect(sharedConversationSyncSource).toContain("export function sortServerConversationHistoryByUpdatedAt")
    expect(sharedConversationSyncSource).toContain("export function getMostRecentServerConversationHistoryItem")
    ...
    expect(sharedConversationSyncSource).toContain("export async function materializeServerConversationCreateRequest")
    expect(sharedConversationSyncSource).toContain("export async function materializeAppendServerConversationMessageRequest")
    expect(sharedConversationSyncSource).toContain("export async function materializeServerConversationRecordContent")
    expect(sharedConversationSyncSource).toContain("export function getSortedServerConversationDataFileNames")
    expect(sharedConversationSyncSource).toContain("export function getServerConversationDataFileName")
    expect(sharedConversationSyncSource).toContain("export function getServerConversationIdFromDataFileName")
    expect(sharedConversationSyncSource).toContain("export function getServerConversationStorageDataPath")
    expect(sharedConversationSyncSource).toContain("export function getServerConversationStorageIndexPath")
    expect(sharedConversationSyncSource).toContain("export function countServerConversationDataFileNames")
    expect(sharedConversationSyncSource).toContain("export function serializeServerConversationRecord")
    expect(sharedConversationSyncSource).toContain("export function serializeServerConversationHistoryIndex")
    ...
    expect(conversationServiceSource).toContain("materializeServerConversationCreateRequest(")
    expect(conversationServiceSource).toContain("getStoredServerConversationMessages(conversation)")
    expect(conversationServiceSource).toContain("materializeAppendServerConversationMessageRequest({")
    expect(conversationServiceSource).toContain("materializeServerConversationRecordContent(conversation")
    expect(conversationServiceSource).toContain("countServerConversationDataFileNames(entries)")
    expect(conversationServiceSource).toContain("getServerConversationStorageDataPath(conversationId, conversationStoragePathOptions)")
    expect(conversationServiceSource).toContain("getServerConversationStorageIndexPath(conversationStoragePathOptions)")
    expect(conversationServiceSource).toContain("getSortedServerConversationDataFileNames(entries)")
    expect(conversationServiceSource).toContain("getServerConversationIdFromDataFileName(entry)")
    expect(conversationServiceSource).toContain("serializeServerConversationRecord(conversation)")
    expect(conversationServiceSource).toContain("serializeServerConversationHistoryIndex(this.indexCache)")
    ...
    expect(conversationServiceSource).toContain("upsertServerConversationHistoryIndex(index, conversation")
    expect(conversationServiceSource).toContain("removeServerConversationHistoryIndexItem(index, conversationId)")
    expect(conversationServiceSource).toContain("parseServerConversationHistoryIndexData<ConversationHistoryItem>(data")
    ...
    expect(conversationServiceSource).toContain("isServerConversationCompactionSummaryLikelyFailed(summaryContent, summarizationPrompt)")
    ...
    expect(conversationServiceSource).toContain("parseServerConversationStorageData<Conversation>(conversationData)")
    expect(conversationServiceSource).toContain("sortServerConversationHistoryByUpdatedAt(index)")
    expect(conversationServiceSource).toContain("getMostRecentServerConversationHistoryItem(history)")
    ...
    expect(sharedConversationMediaAssetsSource).toContain("export function buildConversationImageAssetStoragePlan(")
    expect(sharedConversationMediaAssetsSource).toContain("export function buildConversationVideoAssetStoragePlan(")
    ...
    expect(getConversationServiceSource()).toContain("buildConversationImageAssetStoragePlan(")
    expect(getConversationServiceSource()).toContain("buildConversationVideoAssetStoragePlan(")
