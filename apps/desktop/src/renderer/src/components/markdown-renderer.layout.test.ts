...
describe("markdown renderer layout", () => {
  ...
  it("uses shared video attachment presentation for desktop markdown video links", () => {
    expect(markdownRendererSource).toContain("getChatVideoAttachmentDesktopSurfaceState")
    expect(markdownRendererSource).toContain("getChatVideoAttachmentCopyState")
    expect(markdownRendererSource).toContain("const videoAttachmentCopy = getChatVideoAttachmentCopyState()")
    expect(markdownRendererSource).toContain("const videoAttachmentSurface = getChatVideoAttachmentDesktopSurfaceState()")
    expect(markdownRendererSource).toContain("getVideoAttachmentLoadAccessibilityLabel(displayLabel)")
    ...
    expect(markdownRendererSource).toContain("videoAttachmentCopy.labels.desktopLazyLoadSubtitle")
