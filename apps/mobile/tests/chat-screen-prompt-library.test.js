...
test('can create a new predefined prompt from mobile and save it to desktop settings', () => {
  ...
  assert.match(chatMessageChromeSource, /export function getChatConversationHomePromptSaveSuccessAlertState/);
  assert.match(chatMessageChromeSource, /export function getChatConversationHomePromptSaveFailedAlertState/);
  assert.match(chatMessageChromeSource, /export function getChatConversationHomePromptDeleteConfirmAlertState/);
