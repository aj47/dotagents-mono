...
test('keeps the TTS control inline with assistant message text instead of on a detached row', () => {
  ...
  assert.doesNotMatch(chatMessageChromeSource, /export function createChatMessageConversationThreadBodyInput/);
  assert.match(chatMessageChromeSource, /const resolvedBody = createChatMessageThreadBodyProps\(runtimeThreadParts\.bodySurface\.body\);/);
  assert.match(chatMessageChromeSource, /createChatRuntimeConversationThreadBodyStatusPanelMobilePropsParts,/);
  ...
  assert.match(chatMessageChromeSource, /const statusPanelParts = createChatRuntimeConversationThreadBodyStatusPanelMobilePropsParts\(\{\s+retryStatus,\s+delegationCard,\s+toolApproval,\s+inlineActivity,\s+styles,\s+\}\);/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageRetryStatus\s+\{\.\.\.statusPanelParts\.retryStatus\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageDelegationCard\s+\{\.\.\.statusPanelParts\.delegationCard\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageToolApproval\s+\{\.\.\.statusPanelParts\.toolApproval\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageInlineActivity\s+\{\.\.\.statusPanelParts\.inlineActivity\}/);
  ...
  assert.match(chatMessageChromeSource, /hitSlop=\{collapsedPreviewParts\.pressable\.hitSlop\}/);
  assert.match(chatMessageChromeSource, /collapsedPreviewParts\.pressable\.style,\s+pressed\s+&&\s+!collapsedPreviewParts\.pressable\.disabled\s+&&\s+collapsedPreviewParts\.pressable\.pressedStyle,/);
