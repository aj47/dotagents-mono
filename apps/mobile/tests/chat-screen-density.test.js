...
test('replaces the empty mobile chat home state with quick-start launchers', () => {
  ...
  assert.match(screenSource, /addIcon: promptLibraryShortcutChrome\.addIcon/);
  assert.match(screenSource, /addIconColors: promptLibraryShortcutChrome\.addIconColors/);
  assert.match(screenSource, /sourceIcons: promptLibraryShortcutChrome\.sourceIcons/);
  assert.match(screenSource, /sourceIconColors: promptLibraryShortcutChrome\.sourceIconColors/);
...
test('lets mobile edit and delete desktop saved prompts from quick-start cards', () => {
  ...
  assert.match(screenSource, /editIcon: promptLibraryShortcutChrome\.editIcon/);
  assert.match(screenSource, /editIconColors: promptLibraryShortcutChrome\.editIconColors/);
  assert.match(screenSource, /deleteIcon: promptLibraryShortcutChrome\.deleteIcon/);
  assert.match(screenSource, /deleteIconColors: promptLibraryShortcutChrome\.deleteIconColors/);
