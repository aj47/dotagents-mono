...
import { View, Image, Text, StyleSheet, AppState, AppStateStatus, Platform, TouchableOpacity, useWindowDimensions } from 'react-native';
                    ...
                    <View style={isDesktopShell ? navigationStyles.desktopShellContent : navigationStyles.mobileShellContent}>
                      ...
                      >
                        <Stack.Screen
                          ...
                          options={({ navigation }) => ({
                            title: APP_SHELL_MOBILE_ROUTE_TITLES.Settings,
                            presentation: 'modal',
                            headerLeft: () => (
                              <TouchableOpacity
                                onPress={() => {
                                ...
                                accessibilityRole="button"
                                accessibilityLabel={APP_SHELL_HEADER_ACTIONS.closeSettings.label}
                                style={{ paddingHorizontal: 12, paddingVertical: 8 }}
                              >
                                <Text style={{ color: theme.colors.primary, fontWeight: '600' }}>{APP_SHELL_HEADER_ACTIONS.closeSettings.displayLabel}</Text>
                              </TouchableOpacity>
                            ),
                          })}
                        />
                        <Stack.Screen
                          ...
                          options={{ title: APP_SHELL_MOBILE_ROUTE_TITLES.ConnectionSettings }}
                        />
                        <Stack.Screen
                          name="Operations"
                          component={OperationsScreen}
                          options={{ title: APP_SHELL_MOBILE_ROUTE_TITLES.Operations }}
                        />
                        <Stack.Screen
                          name="Sessions"
                          component={SessionListScreen}
                          options={{ title: APP_SHELL_MOBILE_ROUTE_TITLES.Sessions }}
                        />
                        <Stack.Screen
                          name="SplitChat"
                          component={SplitChatScreen}
                          options={{ title: APP_SHELL_MOBILE_ROUTE_TITLES.SplitChat }}
                        />
                        <Stack.Screen name="Chat" component={ChatScreen} />
                        <Stack.Screen
                          name="AgentEdit"
                          component={AgentEditScreen}
                          options={{ title: APP_SHELL_MOBILE_ROUTE_TITLES.AgentEdit }}
                        />
                        <Stack.Screen
                          name="KnowledgeNoteEdit"
                          component={KnowledgeNoteEditScreen}
                          options={{ title: APP_SHELL_MOBILE_ROUTE_TITLES.KnowledgeNoteEdit }}
                        />
                        <Stack.Screen
                          name="LoopEdit"
                          component={LoopEditScreen}
                          options={{ title: APP_SHELL_MOBILE_ROUTE_TITLES.LoopEdit }}
                        />
                        <Stack.Screen
                          name="SkillEdit"
                          component={SkillEditScreen}
                          options={{ title: APP_SHELL_MOBILE_ROUTE_TITLES.SkillEdit }}
                        />
                      </Stack.Navigator>
                    </View>
