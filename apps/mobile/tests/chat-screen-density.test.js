...
test('derives tool execution card status from displayed non-meta tool entries', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionPayloadCode\s+\{\.\.\.payloadBlockContent\.code\.props\}/);
  ...
  assert.match(sessionPresentationSource, /content: \{[\s\S]*?code: \{\s+props: \{\s+props: \{\s+style: styles\.code,/);
  ...
  assert.doesNotMatch(chatMessageChromeSource, /payloadBlockContent\.code\.(style|text)/);
