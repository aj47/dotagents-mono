...
test('uses desktop-style streaming response chrome while mobile assistant content is live', () => {
  ...
  assert.match(chatMessageChromeSource, /const expandedHeaderContent = header\.content;/);
  ...
  assert.match(chatMessageChromeSource, /<Image\s+\{\.\.\.expandedHeaderContent\.spinner\.props\}/);
  ...
  assert.match(chatMessageChromeSource, /const expandedBodyContent = body\.content;/);
