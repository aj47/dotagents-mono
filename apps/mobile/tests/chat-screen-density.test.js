...
test('replaces the empty mobile chat home state with quick-start launchers', () => {
  ...
  assert.match(screenSource, /const promptLibraryAddShortcutIconColors = useMemo\(\s+\(\) => getPromptLibraryMobileIconColors\(promptLibraryAddShortcutIcon, theme\.colors\),\s+\[theme\.colors\],\s+\);/);
  ...
  assert.match(screenSource, /addIcon: promptLibraryAddShortcutIcon/);
  assert.match(screenSource, /addIconColors: promptLibraryAddShortcutIconColors/);
  assert.match(screenSource, /sourceIcons: promptLibraryShortcutSourceIcons/);
  assert.match(screenSource, /sourceIconColors: promptLibraryShortcutSourceIconColors/);
...
test('lets mobile edit and delete desktop saved prompts from quick-start cards', () => {
  ...
  assert.match(screenSource, /editIcon: promptLibraryEditActionIcon/);
  assert.match(screenSource, /editIconColors: promptLibraryEditActionIconColors/);
  assert.match(screenSource, /deleteIcon: promptLibraryDeleteActionIcon/);
  assert.match(screenSource, /deleteIconColors: promptLibraryDeleteActionIconColors/);
