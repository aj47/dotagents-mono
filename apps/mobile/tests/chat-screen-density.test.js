...
test('derives tool execution card status from displayed non-meta tool entries', () => {
  ...
  assert.doesNotMatch(chatMessageChromeSource, /collapseControlParts\.icon\.(name|size|color)/);
  assert.doesNotMatch(chatMessageChromeSource, /collapseControlParts\.label\.(style|text)/);
  ...
  assert.doesNotMatch(chatMessageChromeSource, /copyButtonParts\.icon\.(name|size|color)/);
  assert.doesNotMatch(chatMessageChromeSource, /copyButtonParts\.label\.(style|text)/);
  ...
  assert.match(sessionPresentationSource, /label: \{\s+props: \{\s+props: \{\s+style: styles\.expandHintText,/);
