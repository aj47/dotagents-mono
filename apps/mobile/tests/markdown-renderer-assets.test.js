...
test('markdown renderer uses shared think-section copy and surface tokens', () => {
  ...
  assert.match(rendererSource, /getMarkdownThinkSectionMobileContainerState/);
  assert.match(rendererSource, /getMarkdownThinkSectionMobileContentState/);
  assert.match(rendererSource, /getMarkdownThinkSectionMobileHeaderState/);
  assert.match(rendererSource, /getMarkdownThinkSectionMobileLabelState/);
  assert.match(rendererSource, /getMarkdownThinkSectionMobileLeadingIconState/);
  assert.match(rendererSource, /getMarkdownThinkSectionMobileSurfaceColors/);
  assert.match(rendererSource, /getMarkdownThinkSectionControlState/);
  assert.match(rendererSource, /type MarkdownThinkSectionMobileSurfaceColors/);
  ...
  assert.match(rendererSource, /const collapsedThinkSectionContainerState = getMarkdownThinkSectionMobileContainerState\(true\);/);
  assert.match(rendererSource, /const expandedThinkSectionContainerState = getMarkdownThinkSectionMobileContainerState\(false\);/);
  assert.match(rendererSource, /const thinkSectionHeaderState = getMarkdownThinkSectionMobileHeaderState\(\);/);
  assert.match(rendererSource, /const thinkSectionLabelState = getMarkdownThinkSectionMobileLabelState\(\);/);
  assert.match(rendererSource, /const thinkSectionContentState = getMarkdownThinkSectionMobileContentState\(\);/);
  assert.match(rendererSource, /const thinkSectionColors = React\.useMemo\([\s\S]*?getMarkdownThinkSectionMobileSurfaceColors\(\{ isDark \}\)/);
  ...
  assert.match(rendererSource, /borderRadius:\s*radius\[collapsedThinkSectionContainerState\.borderRadius\]/);
  ...
  assert.match(rendererSource, /paddingHorizontal:\s*spacing\[thinkSectionHeaderState\.paddingHorizontal\]/);
  assert.match(rendererSource, /color:\s*colors\.label\.color/);
  assert.match(rendererSource, /paddingBottom:\s*spacing\[thinkSectionContentState\.paddingBottom\]/);
  ...
  assert.doesNotMatch(rendererSource, /thinkSectionSurface\./);
...
test('markdown renderer uses shared compact markdown content surface tokens', () => {
  assert.match(rendererSource, /getMarkdownContentMobileSurfaceState/);
  assert.match(rendererSource, /getMarkdownContentMobileSurfaceColors/);
  assert.match(rendererSource, /type MarkdownContentMobileSurfaceColors/);
  assert.match(rendererSource, /const markdownContentSurface = getMarkdownContentMobileSurfaceState\(\);/);
  assert.match(rendererSource, /const markdownContentColors = React\.useMemo\([\s\S]*?getMarkdownContentMobileSurfaceColors\(theme\.colors, \{ isDark \}\)/);
  ...
  assert.match(rendererSource, /getMarkdownCodeBlockCopyLabel\(copied\)/);
  assert.match(rendererSource, /getMarkdownCodeBlockCopyMobileButtonState/);
  ...
  assert.match(rendererSource, /name=\{codeBlockCopyIcon\.name\}/);
  assert.match(rendererSource, /size=\{codeBlockCopyIcon\.size\}/);
  assert.match(rendererSource, /color=\{codeBlockCopyIconColor\}/);
  ...
  assert.match(rendererSource, /codeBlockCopyButton:\s*\{[\s\S]*?position:\s*codeBlockCopyButtonState\.position,[\s\S]*?width:\s*codeBlockCopyButtonState\.size,[\s\S]*?borderColor:\s*markdownContentColors\.codeBlockCopyButton\.borderColor/);
  assert.match(rendererSource, /codeBlockCopyButton:\s*\{[\s\S]*?alignItems:\s*codeBlockCopyButtonState\.alignItems,[\s\S]*?justifyContent:\s*codeBlockCopyButtonState\.justifyContent,/);
  assert.match(rendererSource, /code_block: \(node: any\) => \(/);
  assert.match(rendererSource, /fence: \(node: any\) => \(/);
  assert.match(rendererSource, /codeBlockCopyButtonCopied:\s*\{[\s\S]*?borderColor:\s*markdownContentColors\.codeBlockCopyButton\.copiedBorderColor,[\s\S]*?backgroundColor:\s*markdownContentColors\.codeBlockCopyButton\.copiedBackgroundColor/);
