...
test('derives tool execution card status from displayed non-meta tool entries', () => {
  ...
  assert.match(sessionPresentationSource, /label: \{\s+props: \{\s+accessibilityRole: renderState\.accessibilityRole,\s+accessibilityLabel: renderState\.accessibilityLabel,\s+style,\s+text: renderState\.label,/);
