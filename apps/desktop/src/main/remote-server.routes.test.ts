...
describe("remote-server route registration", () => {
  ...
  it("exposes remote server, tunnel, and Discord settings in the remote settings GET/PATCH routes", () => {
    ...
    expect(settingsGetSection).toContain("handsFree")
    expect(settingsGetSection).toContain("handsFreeMessageDebounceMs")
    expect(settingsGetSection).toContain("handsFreeWakePhrase")
    ...
    expect(settingsPatchSection).toContain("body.handsFree")
    expect(settingsPatchSection).toContain("updates.handsFreeMessageDebounceMs")
    expect(settingsPatchSection).toContain("updates.handsFreeWakePhrase")
