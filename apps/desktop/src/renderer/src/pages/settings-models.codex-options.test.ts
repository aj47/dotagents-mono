...
describe("settings models Codex generation options", () => {
  ...
  it("uses shared provider fallback defaults for model sections", () => {
    ...
    expect(settingsModelsSource).toContain("DEFAULT_TRANSCRIPT_POST_PROCESSING_ENABLED")
    ...
    expect(settingsModelsSource).toContain("config.transcriptPostProcessingEnabled ?? DEFAULT_TRANSCRIPT_POST_PROCESSING_ENABLED")
