...
test('lets mobile respond to desktop tool approval requests from progress updates', () => {
  ...
  assert.match(toolApprovalComponentSource, /const denyButtonContent = toolApprovalParts\.denyButton\.content;/);
  assert.match(toolApprovalComponentSource, /const approveButtonContent = toolApprovalParts\.approveButton\.content;/);
  ...
  assert.match(toolApprovalComponentSource, /<ChatMessageToolApprovalIcon\s+\{\.\.\.denyButtonContent\.icon\.props\}/);
  assert.doesNotMatch(toolApprovalComponentSource, /denyButtonContent\.icon\.(name|size|color)/);
  ...
  assert.match(toolApprovalComponentSource, /<ChatMessageToolApprovalActionLabel\s+\{\.\.\.denyButtonContent\.label\.props\}/);
  ...
  assert.doesNotMatch(toolApprovalComponentSource, /denyButtonContent\.label\.text/);
  ...
  assert.match(toolApprovalComponentSource, /<ChatMessageToolApprovalIcon\s+\{\.\.\.approveButtonContent\.icon\.props\}/);
  assert.doesNotMatch(toolApprovalComponentSource, /approveButtonContent\.icon\.(name|size|color)/);
  ...
  assert.match(toolApprovalComponentSource, /<ChatMessageToolApprovalSpinner\s+\{\.\.\.approveButtonContent\.spinner\.props\}/);
  ...
  assert.doesNotMatch(toolApprovalComponentSource, /approveButtonContent\.spinner\.(size|color)/);
  assert.match(toolApprovalComponentSource, /\{approveButtonContent\.spinner\.shouldRender \? \(/);
  assert.match(toolApprovalComponentSource, /approveButtonContent\.icon\.shouldRender \? \(/);
  assert.doesNotMatch(toolApprovalComponentSource, /\{approveButtonContent\.spinner \? \(/);
  assert.doesNotMatch(toolApprovalComponentSource, /approveButtonContent\.icon \? \(/);
  ...
  assert.match(toolApprovalComponentSource, /<ChatMessageToolApprovalActionLabel\s+\{\.\.\.approveButtonContent\.label\.props\}/);
  assert.doesNotMatch(toolApprovalComponentSource, /approveButtonContent\.label\.text/);
