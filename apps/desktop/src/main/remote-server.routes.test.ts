...
describe("remote-server route registration", () => {
  ...
  it("routes mobile chat requests through the shared agent runner", () => {
    ...
    expect(mobileApiDesktopActionsSource).toContain("handleChatCompletionRequestAction(")
  ...
  it("delegates agent profile route behavior to agent profile actions", () => {
    ...
    expect(mobileApiDesktopActionsSource).toContain("const agentProfileRouteActions = createAgentProfileRouteActions({")
  ...
  it("delegates conversation sync and media routes to conversation actions", () => {
    ...
    expect(mobileApiDesktopActionsSource).toContain("return getConversationVideoAssetAction(")
