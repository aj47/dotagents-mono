...
For production observability without terminal access, use the [Langfuse integration](../tools/observability.md):
...
- **[Observability](../tools/observability.md)** — Langfuse integration for production
- **[Development Setup](../development/setup.md)** — Full dev environment
- **[Remote API](api.md)** — API endpoint debugging
