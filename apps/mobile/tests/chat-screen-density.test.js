...
test('replaces the empty mobile chat home state with quick-start launchers', () => {
  ...
  assert.match(screenSource, /getPromptLibraryMobileShortcutCopyState,/);
  ...
  assert.match(screenSource, /const promptLibraryShortcutCopy = getPromptLibraryMobileShortcutCopyState\(\);/);
  ...
  assert.match(screenSource, /shortcutCopy: promptLibraryShortcutCopy/);
  ...
  assert.match(chatMessageChromeSource, /shortcutCopy: PromptLibraryMobileShortcutCopyState;/);
...
test('lets mobile edit and delete desktop saved prompts from quick-start cards', () => {
  ...
  assert.match(screenSource, /editorChrome: promptLibraryEditorChrome/);
  ...
  assert.match(chatMessageChromeSource, /editorChrome: PromptLibraryEditorMobileChromeState;/);
