...
test('uses shared runtime header copy for mobile stop and hands-free controls', () => {
  ...
  assert.match(screenSource, /\.\.\.createChatRuntimeHeaderIconContainerMobileStyleSlot\(\{\s+size: headerSurface\.killSwitchButton\.size,\s+borderRadius: headerSurface\.killSwitchButton\.borderRadius,\s+backgroundColor: headerKillSwitchButtonColors\.button\.backgroundColor,\s+alignItems: headerSurface\.killSwitchButton\.alignItems,\s+justifyContent: headerSurface\.killSwitchButton\.justifyContent,/);
  ...
  assert.match(screenSource, /headerHandsFreeIconContainer:\s*\{[\s\S]*?\.\.\.createChatRuntimeHeaderIconContainerMobileStyleSlot\(\{\s+size: headerSurface\.handsFreeButton\.size,\s+alignItems: headerSurface\.handsFreeButton\.alignItems,\s+justifyContent: headerSurface\.handsFreeButton\.justifyContent,/);
