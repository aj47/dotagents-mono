...
- **[Desktop App](../desktop/overview.md)** — Full desktop feature guide
- **[Mobile App](../mobile/overview.md)** — Voice on the go
- **[AI Providers](../tools/providers.md)** — Configure STT/TTS providers
- **[Keyboard Shortcuts](../configuration/shortcuts.md)** — All voice hotkeys
