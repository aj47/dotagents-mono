...
| `docs-site` | Docusaurus documentation app | [Development Setup](setup), [Build, Release, Deploy](build-release-deploy), this page | Build with `pnpm --dir docs-site build`; keep sidebar generated by categories. |
| `website` | Static marketing site and deploy assets for dotagents.app | Root README, website README, [Build, Release, Deploy](build-release-deploy), this page | The docs site covers product behavior; website docs cover static asset/deploy mechanics. |
