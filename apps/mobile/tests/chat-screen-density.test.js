...
test('lets mobile respond to desktop tool approval requests from progress updates', () => {
  ...
  assert.match(chatMessageChromeSource, /const cardRenderState = getChatRuntimeToolApprovalCardMobileRenderState\(\{\s+isApproval,\s+toolApproval,\s+expandedToolApprovals,\s+pendingApprovalResponseId,\s+colors,\s+\}\);/);
