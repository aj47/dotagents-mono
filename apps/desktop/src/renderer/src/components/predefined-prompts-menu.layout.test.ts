...
describe("predefined prompts menu layout", () => {
  it("keeps the trigger and dropdown content readable in dense desktop composer chrome", () => {
    ...
    expect(predefinedPromptsMenuSource).toContain("PROMPT_LIBRARY_PRESENTATION.triggerAccessibilityLabel")
  ...
  it("adds a top search filter for prompts, skills, and tasks", () => {
    ...
    expect(predefinedPromptsMenuSource).toContain("PROMPT_LIBRARY_PRESENTATION.search.placeholder")
    expect(predefinedPromptsMenuSource).toContain("PROMPT_LIBRARY_PRESENTATION.search.accessibilityLabel")
  ...
  it("uses shared predefined prompt mutation helpers", () => {
    ...
    expect(predefinedPromptsMenuSource).toContain("PROMPT_LIBRARY_PRESENTATION")
