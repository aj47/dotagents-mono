...
Open DotAgents after [installing](installation). On first launch, you'll see the **onboarding wizard** that walks you through initial setup.
...
Now your agent can read and write files on your behalf. See [MCP Tools](/tools/mcp) for more servers.
...
- **[Agent Skills](/agents/skills)** — Teach your agent new capabilities
- **[MCP Tools](/tools/mcp)** — Connect more tools and services
