...
test('lets mobile respond to desktop tool approval requests from progress updates', () => {
  ...
  assert.match(chatMessageChromeSource, /return \{[\s\S]*?renderState: cardState\.renderState,[\s\S]*?toolName: cardState\.toolName,[\s\S]*?argumentsPreview: cardState\.argumentsPreview,[\s\S]*?argumentsContent: cardState\.argumentsContent,/);
  ...
  assert.match(chatMessageChromeSource, /onToggleArguments: cardState\.onToggleArguments,/);
  assert.match(chatMessageChromeSource, /onDeny: cardState\.onDeny,/);
  assert.match(chatMessageChromeSource, /onApprove: cardState\.onApprove,/);
...
test('shows desktop-style retry status updates from shared runtime presentation', () => {
  ...
  assert.match(chatMessageChromeSource, /return renderState\s+\? \{\s+renderState,\s+\}\s+: null;/);
...
test('renders delegated agent progress as compact desktop-style mobile chrome', () => {
  ...
  assert.match(chatMessageChromeSource, /const presentationState = getChatRuntimeDelegationCardMobilePresentationState\(cardInput\);/);
  assert.match(chatMessageChromeSource, /\.\.\.presentationState,/);
  assert.match(chatMessageChromeSource, /onShowAll: \(\) => onShowAllConversationPreview\(presentationState\.runId\),/);
  assert.match(chatMessageChromeSource, /onShowAll: \(\) => onShowAllToolPreview\(presentationState\.runId\),/);
  ...
  assert.match(chatMessageChromeSource, /const presentationState = getChatRuntimeDelegationCardMobilePresentationState\(cardInput\);/);
  assert.match(chatMessageChromeSource, /if \(!presentationState\) return null;/);
