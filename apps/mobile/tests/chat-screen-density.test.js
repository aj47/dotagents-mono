...
test('keeps the TTS control inline with assistant message text instead of on a detached row', () => {
  ...
  assert.match(screenSource, /getChatMessageActionMobileButtonRenderState,/);
  ...
  assert.match(screenSource, /getChatMessageActionMobileButtonRenderState,/);
  assert.doesNotMatch(screenSource, /getChatMessageActionMobileButtonColors,/);
  assert.match(screenSource, /const mobileMessageActionButtonStyleState = getChatMessageActionMobileButtonRenderState\(\{\s+colors: theme\.colors,\s+\}\);/);
  assert.match(screenSource, /const mobileMessageBranchButtonStyleState = getChatMessageActionMobileButtonRenderState\(\{\s+kind: 'branch',\s+colors: theme\.colors,\s+\}\);/);
  assert.match(screenSource, /const mobileMessageCopiedButtonStyleState = getChatMessageActionMobileButtonRenderState\(\{\s+kind: 'copied',\s+colors: theme\.colors,\s+\}\);/);
  assert.match(screenSource, /const mobileMessageSpeechButtonStyleState = getChatMessageActionMobileButtonRenderState\(\{\s+kind: 'speech',\s+colors: theme\.colors,\s+\}\);/);
  assert.match(screenSource, /const mobileMessageSpeechActiveButtonStyleState = getChatMessageActionMobileButtonRenderState\(\{\s+kind: 'speechActive',\s+colors: theme\.colors,\s+\}\);/);
  assert.match(screenSource, /const mobileMessageActionButton = mobileMessageActionButtonStyleState\.button;/);
  assert.match(screenSource, /const mobileMessageBranchButton = mobileMessageBranchButtonStyleState\.button;/);
  assert.match(screenSource, /const mobileMessageSpeechButton = mobileMessageSpeechButtonStyleState\.button;/);
  assert.match(screenSource, /const mobileMessageActionButtonColors = mobileMessageActionButtonStyleState\.colors;/);
  assert.match(screenSource, /const mobileMessageBranchButtonColors = mobileMessageBranchButtonStyleState\.colors;/);
  assert.match(screenSource, /const mobileMessageCopiedButtonColors = mobileMessageCopiedButtonStyleState\.colors;/);
  assert.match(screenSource, /const mobileMessageSpeechButtonColors = mobileMessageSpeechButtonStyleState\.colors;/);
  assert.match(screenSource, /const mobileMessageSpeechActiveButtonColors = mobileMessageSpeechActiveButtonStyleState\.colors;/);
