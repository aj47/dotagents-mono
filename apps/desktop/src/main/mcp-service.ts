...
export interface MCPToolCall {
  /**
   * Optional stable id used to pair this tool call with its MCPToolResult
   * when replaying conversation history to the LLM. Generated by the agent
   * loop when the underlying provider doesn't supply one.
   */
  id?: string
  name: string
  arguments: any
...
export interface MCPToolResult {
  /**
   * Id of the MCPToolCall this result corresponds to. Preserved across
   * persistence so replayed conversations can emit correctly-paired
   * AI SDK tool-call / tool-result parts.
   */
  toolCallId?: string
  content: Array<{
    type: "text"
