...
test('keeps agent selection in the navigation header for the mobile chat screen', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /agentSelectorStyles: \{\s+button: styles\.headerAgentSelectorButton,\s+chip: styles\.headerAgentSelectorChip,\s+label: styles\.headerAgentSelectorText,/);
...
test('shows a conversation-state chip in the mobile chat header while preserving the compact header actions row', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /conversationStatusStyles: \{\s+chip: styles\.headerConversationChip,\s+text: styles\.headerConversationChipText,\s+spinner: styles\.headerConversationSpinner,/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /actionsRowStyle: styles\.headerActionsRow,/);
...
test('shows the shared total agent time in the mobile chat header', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /turnDurationStyles: \{\s+chip: styles\.headerDurationChip,\s+liveChip: styles\.headerDurationChipLive,\s+text: styles\.headerDurationChipText,\s+liveText: styles\.headerDurationChipTextLive,/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /styles\.headerDurationChip/);
  assert.match(chatRuntimeMobileStylesSource, /styles\.headerDurationChipLive/);
  assert.match(chatRuntimeMobileStylesSource, /styles\.headerDurationChipText/);
  assert.match(chatRuntimeMobileStylesSource, /styles\.headerDurationChipTextLive/);
  assert.match(chatMessageChromeSource, /name=\{renderState\.icon\.name\}/);
  assert.match(chatMessageChromeSource, /size=\{renderState\.icon\.size\}/);
  assert.match(chatMessageChromeSource, /color=\{renderState\.icon\.color\}/);
...
test('keeps pinning available from the individual chat view header', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /iconButtonStyles: \{\s+edgeStyle: styles\.headerEdgeActionButton,\s+pinStyle: styles\.headerPinButton,\s+pinActiveStyle: styles\.headerPinButtonActive,/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /styles\.headerPinButton/);
...
test('uses shared runtime header copy for mobile stop and hands-free controls', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /killSwitchIconContainerStyle: styles\.headerKillSwitchIconContainer,/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /handsFreeIconContainerStyle: styles\.headerHandsFreeIconContainer,/);
...
test('uses shared runtime presentation for mobile scroll-to-bottom affordance', () => {
  ...
  assert.match(screenSource, /createChatMessageConnectionBannerStyleSlots,/);
  assert.match(screenSource, /createChatMessageRuntimeDockStyleSlots,/);
  assert.match(chatRuntimeMobileStylesSource, /createChatMessageConversationDockStyleSlots,[\s\S]*?createChatMessageRuntimeDockStyleSlots,[\s\S]*?\} from '@dotagents\/shared\/session-presentation';/);
  assert.match(chatRuntimeMobileStylesSource, /createChatMessageConnectionBannerStyleSlots,[\s\S]*?createChatMessageConversationDockStyleSlots,[\s\S]*?\} from '@dotagents\/shared\/session-presentation';/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /const conversationDockStyles = useMemo\(\s+\(\) => createChatMessageConversationDockStyleSlots\(\{\s+scrollToBottomButtonStyle: styles\.scrollToBottomButton,\s+queuePanelStyle: styles\.messageQueuePanelWrapper,\s+connectionBannerStyles: createChatMessageConnectionBannerStyleSlots\(\{\s+bannerStyle: styles\.connectionBanner,\s+reconnectingStyle: styles\.connectionBannerReconnecting,\s+failedStyle: styles\.connectionBannerFailed,\s+contentStyle: styles\.connectionBannerContent,\s+iconStyle: styles\.connectionBannerIcon,\s+textContainerStyle: styles\.connectionBannerTextContainer,\s+titleStyle: styles\.connectionBannerText,\s+subtitleStyle: styles\.connectionBannerSubtext,\s+retryButtonStyle: styles\.retryButton,\s+retryButtonTextStyle: styles\.retryButtonText,\s+\}\),\s+\}\),\s+\[styles\],\s+\);/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /scrollToBottomButtonStyle: styles\.scrollToBottomButton,/);
...
test('uses shared runtime presentation for the mobile chat viewport and loading state', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /const conversationViewportStyles = useMemo\(\s+\(\) => createChatMessageConversationViewportStyleSlots\(\{\s+frameStyles: \{\s+keyboardAvoidingStyle: styles\.keyboardAvoidingContainer,\s+rootStyle: styles\.chatRoot,\s+\},\s+scrollViewportStyles: \{\s+style: styles\.chatScroll,\s+contentContainerStyle: styles\.chatScrollContent,\s+\},/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /frameStyles: \{\s+keyboardAvoidingStyle: styles\.keyboardAvoidingContainer,\s+rootStyle: styles\.chatRoot,\s+\}/);
  assert.match(chatRuntimeMobileStylesSource, /scrollViewportStyles: \{\s+style: styles\.chatScroll,\s+contentContainerStyle: styles\.chatScrollContent,\s+\}/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /loadingStateStyles: \{\s+style: styles\.loadingState,\s+spinnerStyle: styles\.loadingSpinner,/);
...
test('uses shared runtime presentation for mobile connection and retry banners', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /connectionBannerStyles: createChatMessageConnectionBannerStyleSlots\(\{\s+bannerStyle: styles\.connectionBanner,\s+reconnectingStyle: styles\.connectionBannerReconnecting,\s+failedStyle: styles\.connectionBannerFailed,\s+contentStyle: styles\.connectionBannerContent,/);
  assert.match(chatRuntimeMobileStylesSource, /iconStyle: styles\.connectionBannerIcon,\s+textContainerStyle: styles\.connectionBannerTextContainer,\s+titleStyle: styles\.connectionBannerText,\s+subtitleStyle: styles\.connectionBannerSubtext,/);
  assert.match(chatRuntimeMobileStylesSource, /retryButtonStyle: styles\.retryButton,\s+retryButtonTextStyle: styles\.retryButtonText,\s+\}/);
  assert.match(sessionPresentationSource, /connectionBanner: connectionBannerStyles,/);
...
test('uses shared desktop-style icons for mobile composer controls', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /pendingImagesRailStyles: \{\s+row: styles\.pendingImagesRow,\s+card: styles\.pendingImageCard,\s+preview: styles\.pendingImagePreview,\s+removeButton: styles\.pendingImageRemoveButton,/);
  assert.match(chatRuntimeMobileStylesSource, /voiceOverlayStyles: \{\s+overlay: styles\.overlay,\s+card: styles\.overlayCard,\s+label: styles\.overlayText,\s+transcript: styles\.overlayTranscript,/);
  assert.match(chatRuntimeMobileStylesSource, /handsFreeControlsStyles: \{\s+statusRow: styles\.handsFreeStatusRow,\s+controlsRow: styles\.handsFreeControlsRow,\s+controlButton: styles\.handsFreeControlButton,\s+controlButtonText: styles\.handsFreeControlButtonText,/);
  assert.match(chatRuntimeMobileStylesSource, /accessoryButtonStyles: \{\s+style: styles\.ttsToggle,\s+activeStyle: styles\.ttsToggleOn,/);
  assert.match(chatRuntimeMobileStylesSource, /textEntryStyles: \{\s+input: styles\.input,\s+visuallyHiddenHint: styles\.visuallyHiddenComposerHint,/);
  assert.match(chatRuntimeMobileStylesSource, /queueActionStyles: \{\s+button: styles\.queueButton,\s+disabledButton: styles\.sendButtonDisabled,\s+text: styles\.queueButtonText,/);
  assert.match(chatRuntimeMobileStylesSource, /submitActionStyles: \{\s+button: styles\.sendButton,\s+disabledButton: styles\.sendButtonDisabled,\s+text: styles\.sendButtonText,/);
  assert.match(chatRuntimeMobileStylesSource, /micButtonStyles: \{\s+button: styles\.mic,\s+activeButton: styles\.micOn,\s+label: styles\.micLabel,\s+activeLabel: styles\.micLabelOn,/);
  assert.match(chatRuntimeMobileStylesSource, /inputDockStyles: \{\s+area: styles\.inputArea,\s+row: styles\.inputRow,\s+micWrapper: styles\.micWrapper,/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /accessoryButtonStyles: \{\s+style: styles\.ttsToggle,\s+activeStyle: styles\.ttsToggleOn,\s+\}/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /speechPreviewStyles: \{\s+box: styles\.sttPreviewBox,\s+label: styles\.sttPreviewLabel,\s+text: styles\.sttPreviewText,\s+\}/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /queueActionStyles: \{\s+button: styles\.queueButton,\s+disabledButton: styles\.sendButtonDisabled,\s+text: styles\.queueButtonText,\s+\}/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /submitActionStyles: \{\s+button: styles\.sendButton,\s+disabledButton: styles\.sendButtonDisabled,\s+text: styles\.sendButtonText,\s+\}/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /micButtonStyles: \{\s+button: styles\.mic,\s+activeButton: styles\.micOn,\s+label: styles\.micLabel,\s+activeLabel: styles\.micLabelOn,\s+\}/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /textEntryStyles: \{\s+input: styles\.input,\s+visuallyHiddenHint: styles\.visuallyHiddenComposerHint,\s+\}/);
...
test('uses shared mobile icon chrome for pending image removal', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /pendingImagesRailStyles: \{\s+row: styles\.pendingImagesRow,\s+card: styles\.pendingImageCard,\s+preview: styles\.pendingImagePreview,\s+removeButton: styles\.pendingImageRemoveButton,\s+\}/);
...
test('keeps the live voice overlay compact by grouping status and transcript into one card', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /voiceOverlayStyles: \{\s+overlay: styles\.overlay,\s+card: styles\.overlayCard,\s+label: styles\.overlayText,\s+transcript: styles\.overlayTranscript,\s+\}/);
...
test('uses shared runtime activity copy for mobile loading and thinking states', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /historyBannerStyles: \{\s+container: styles\.loadOlderContainer,\s+summary: styles\.loadOlderText,\s+loadButton: styles\.loadOlderButton,\s+loadButtonPressed: styles\.loadOlderButtonPressed,\s+loadButtonText: styles\.loadOlderButtonText,/);
...
test('surfaces desktop step summaries as compact mobile runtime chrome without persisting them as messages', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /stepSummaryStyles: \{\s+card: styles\.stepSummaryCard,\s+header: styles\.stepSummaryHeader,\s+title: styles\.stepSummaryTitle,\s+badge: styles\.stepSummaryBadge,\s+badgeText: styles\.stepSummaryBadgeText,\s+action: styles\.stepSummaryAction,\s+meta: styles\.stepSummaryMeta,\s+preview: styles\.stepSummaryPreview,/);
...
test('uses shared message queue surface tokens for the chat-adjacent queue wrapper', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /queuePanelStyle: styles\.messageQueuePanelWrapper,/);
...
test('uses tool activities wording consistently for grouped tool activity labels', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /const chatMessageConversationThreadStyles = useMemo\(\s+\(\) => createChatMessageConversationThreadStyleSlots\(\{\s+threadSurfaceStyles: createChatMessageToolActivityGroupThreadSurfaceStyleSlots\(\{\s+surfaceStyle: styles\.msg,\s+boundaryStyles: createChatMessageToolActivityGroupBoundaryStyles\(\{/);
  assert.match(chatRuntimeMobileStylesSource, /speechStyles: \{\s+style: styles\.speakButton,\s+activeStyle: styles\.speakButtonActive,\s+pressedStyle: styles\.speakButtonPressed,/);
  assert.match(chatRuntimeMobileStylesSource, /branchStyles: \{\s+style: styles\.messageBranchButton,\s+pressedStyle: styles\.messageBranchButtonPressed,\s+disabledStyle: styles\.messageBranchButtonDisabled,/);
  assert.match(chatRuntimeMobileStylesSource, /copyStyles: \{\s+style: styles\.messageCopyButton,\s+activeStyle: styles\.messageCopyButtonCopied,\s+pressedStyle: styles\.messageCopyButtonPressed,/);
  assert.match(chatRuntimeMobileStylesSource, /expansionStyles: \{\s+style: styles\.messageExpandButton,\s+pressedStyle: styles\.messageExpandButtonPressed,/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /surfaceStyle: styles\.msg,\s+boundaryStyles: createChatMessageToolActivityGroupBoundaryStyles\(\{/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /getToneStyle: \(toneStyleSlot: ChatRuntimeConversationSurfaceToneMobileStyleSlot\) => \(\s+styles\[toneStyleSlot\]\s+\),/);
  assert.match(chatRuntimeMobileStylesSource, /toggleContainerStyle: styles\.toolActivityGroupCollapsed,\s+togglePressedStyle: styles\.toolActivityGroupPressed,\s+toggleHeaderRowStyle: styles\.toolActivityGroupHeaderRow,\s+toggleCountBadgeStyle: styles\.toolActivityGroupCountBadge,\s+toggleCountBadgeTextStyle: styles\.toolActivityGroupCountBadgeText,\s+togglePreviewLineStyle: styles\.toolActivityGroupPreviewLine,/);
  assert.match(chatRuntimeMobileStylesSource, /footerButtonStyle: styles\.toolActivityGroupFooterButton,\s+footerPressedStyle: styles\.toolActivityGroupPressed,\s+footerTextStyle: styles\.toolActivityGroupFooterText,/);
...
test('keeps the TTS control inline with assistant message text instead of on a detached row', () => {
  ...
  assert.match(sessionPresentationSource, /delegationCard: createChatRuntimeDelegationCardMobileProps\(delegationCard\),/);
  assert.match(sessionPresentationSource, /toolApproval: createChatRuntimeConversationToolApprovalMobileProps\(toolApproval\),/);
  assert.match(chatRuntimeMobileStylesSource, /turnDurationStyles: \{\s+style: styles\.messageTurnDurationBadge,\s+liveStyle: styles\.messageTurnDurationBadgeLive,\s+textStyle: styles\.messageTurnDurationText,\s+liveTextStyle: styles\.messageTurnDurationTextLive,\s+\}/);
  ...
  assert.match(chatRuntimeMobileStylesSource, /speechStyles: \{\s+style: styles\.speakButton,\s+activeStyle: styles\.speakButtonActive,\s+pressedStyle: styles\.speakButtonPressed,\s+\}/);
...
test('uses shared runtime presentation for mobile request and queue debug copy', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /debugPanelStyles: \{\s+panelStyle: styles\.debugInfo,\s+textStyle: styles\.debugText,/);
  assert.match(chatMessageChromeSource, /export function ChatMessageDebugPanel/);
  assert.match(chatMessageChromeSource, /export function ChatMessageDebugPanelStack/);
...
test('replaces the empty mobile chat home state with quick-start launchers', () => {
  ...
  assert.match(chatMessageChromeSource, /export function ChatConversationHomeQuickStarts/);
  assert.match(chatRuntimeMobileStylesSource, /homeQuickStartStyles: \{\s+card: styles\.chatHomeCard,\s+emptyText: styles\.chatHomeEmptyText,\s+grid: styles\.chatHomeShortcutGrid,\s+shortcutCard: styles\.chatHomeShortcutCard,/);
  assert.match(chatMessageChromeSource, /if \(!shouldRender\) return null;/);
...
test('lets mobile edit and delete desktop saved prompts from quick-start cards', () => {
  ...
  assert.match(screenSource, /const promptEditorModalStyles = useMemo\(\s+\(\) => createChatConversationHomePromptEditorModalStyleSlots\(\{\s+keyboardAvoidingViewStyle: styles\.modalKeyboardAvoidingView,/);
  assert.match(chatScreenSource, /\.\.\.chatRuntimeChrome\.messageRuntime,/);
  ...
  assert.match(screenSource, /overlayStyle: styles\.modalOverlay,\s+contentStyle: styles\.modalContent,\s+headerStyle: styles\.modalHeader,/);
  assert.match(screenSource, /saveButtonStyle: styles\.modalSaveButton,\s+saveButtonDisabledStyle: styles\.modalSaveButtonDisabled,\s+saveButtonTextStyle: styles\.modalSaveButtonText,/);
...
test('lets mobile branch linked desktop conversations from individual messages', () => {
  ...
  assert.match(sessionPresentationSource, /branch: \{\s+hitSlop: actionButtons\.branch\.hitSlop,\s+\.\.\.branchStyles,\s+\}/);
  assert.match(chatRuntimeMobileStylesSource, /branchStyles: \{\s+style: styles\.messageBranchButton,\s+pressedStyle: styles\.messageBranchButtonPressed,\s+disabledStyle: styles\.messageBranchButtonDisabled,\s+\}/);
