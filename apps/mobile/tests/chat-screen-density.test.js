...
test('derives tool execution card status from displayed non-meta tool entries', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionPayloadPreview\s+\{\.\.\.payloadBlockParts\.preview\.props\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionPayloadScroll\s+\{\.\.\.payloadBlockParts\.scroll\.props\}/);
  ...
  assert.match(sessionPresentationSource, /preview: \{\s+shouldRender: Boolean\(compactText\),\s+props: \{\s+props: \{\s+style: styles\.preview,\s+numberOfLines: previewNumberOfLines,/);
  ...
  assert.match(sessionPresentationSource, /code: \{\s+props: \{\s+props: \{\s+style: styles\.code,/);
  assert.doesNotMatch(chatMessageChromeSource, /payloadBlockParts\.preview\.(style|numberOfLines|text)/);
  assert.doesNotMatch(chatMessageChromeSource, /payloadBlockParts\.scroll\.(style|nestedScrollEnabled)/);
  assert.doesNotMatch(chatMessageChromeSource, /payloadBlockParts\.code\.(style|text)/);
