...
test('uses shared runtime presentation for mobile connection and retry banners', () => {
  ...
  assert.match(connectionBannerSource, /const reconnectingContent = connectionBannerParts\.reconnecting\.container\.content;/);
  ...
  assert.match(connectionBannerSource, /const failedContent = connectionBannerParts\.failed\.container\.content;/);
