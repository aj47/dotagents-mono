...
test('renders delegated agent progress as compact desktop-style mobile chrome', () => {
  ...
  assert.match(delegationCardComponentSource, /numberOfLines=\{delegationCardParts\.conversationPreview\.moreAction\.label\.numberOfLines\}/);
  assert.match(delegationCardComponentSource, /\{delegationCardParts\.conversationPreview\.moreAction\.label\.text\}/);
  ...
  assert.match(delegationCardComponentSource, /accessibilityRole=\{delegationCardParts\.toolPreview\.moreAction\.button\.accessibilityRole\}/);
  assert.match(delegationCardComponentSource, /accessibilityLabel=\{delegationCardParts\.toolPreview\.moreAction\.button\.accessibilityLabel\}/);
  ...
  assert.match(delegationCardComponentSource, /numberOfLines=\{delegationCardParts\.toolPreview\.moreAction\.label\.numberOfLines\}/);
  assert.match(delegationCardComponentSource, /\{delegationCardParts\.toolPreview\.moreAction\.label\.text\}/);
