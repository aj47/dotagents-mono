...
test('uses shared runtime presentation for mobile request and queue debug copy', () => {
  ...
  assert.match(chatMessageChromeSource, /getChatRuntimeDebugMessage\('unknownError'\)/);
  ...
  assert.match(chatMessageChromeSource, /const message = getChatRuntimeAlertMessage\(\s+error,\s+getChatRuntimeDebugMessage\('unknownError'\),\s+\);/);
  ...
  assert.match(chatMessageChromeSource, /updateMessages: \(messages\) => appendChatMessageRuntimePendingTurnMessages\(messages, userMessage\)/);
