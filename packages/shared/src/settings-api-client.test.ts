...
describe('SettingsApiClient', () => {
  ...
  it('covers every settings-manageable remote API route through shared client methods', async () => {
    ...
    const imageFileName = 'image/name.png';
    ...
    const scenarios: Array<{
      ...
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.agentSessionToolApprovalResponse }, expectedPath: REMOTE_SERVER_API_BUILDERS.agentSessionToolApprovalResponse('approval/1'), run: () => client.respondToToolApproval('approval/1', true) },
      ...
      { route: { method: 'GET', path: REMOTE_SERVER_API_PATHS.operatorDiagnosticReport }, expectedPath: REMOTE_SERVER_API_PATHS.operatorDiagnosticReport, run: () => client.getOperatorDiagnosticReport() },
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.operatorDiagnosticReportSave }, expectedPath: REMOTE_SERVER_API_PATHS.operatorDiagnosticReportSave, run: () => client.saveOperatorDiagnosticReport('/tmp/report.json') },
      ...
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.operatorErrorsClear }, expectedPath: REMOTE_SERVER_API_PATHS.operatorErrorsClear, run: () => client.clearOperatorErrors() },
      { route: { method: 'GET', path: REMOTE_SERVER_API_PATHS.operatorChatGptWebAuth }, expectedPath: REMOTE_SERVER_API_PATHS.operatorChatGptWebAuth, run: () => client.getChatGptWebAuthStatus() },
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.operatorChatGptWebAuthLogin }, expectedPath: REMOTE_SERVER_API_PATHS.operatorChatGptWebAuthLogin, run: () => client.loginChatGptWebOAuth() },
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.operatorChatGptWebAuthLogout }, expectedPath: REMOTE_SERVER_API_PATHS.operatorChatGptWebAuthLogout, run: () => client.logoutChatGptWebOAuth() },
      ...
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.operatorDesktopMainWindowShow }, expectedPath: REMOTE_SERVER_API_PATHS.operatorDesktopMainWindowShow, run: () => client.showOperatorMainWindow() },
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.operatorDesktopPanelWindowShow }, expectedPath: REMOTE_SERVER_API_PATHS.operatorDesktopPanelWindowShow, run: () => client.showOperatorPanelWindow() },
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.operatorDesktopPanelWindowHide }, expectedPath: REMOTE_SERVER_API_PATHS.operatorDesktopPanelWindowHide, run: () => client.hideOperatorPanelWindow() },
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.operatorDesktopPanelWindowReset }, expectedPath: REMOTE_SERVER_API_PATHS.operatorDesktopPanelWindowReset, run: () => client.resetOperatorPanelWindow() },
      ...
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.operatorAgentSessionUnsnooze }, expectedPath: REMOTE_SERVER_API_BUILDERS.operatorAgentSessionUnsnooze(sessionId), run: () => client.unsnoozeOperatorAgentSession(sessionId) },
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.operatorAgentSessionClear }, expectedPath: REMOTE_SERVER_API_BUILDERS.operatorAgentSessionClear(sessionId), run: () => client.clearOperatorAgentSession(sessionId) },
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.operatorAgentSessionsClearInactive }, expectedPath: REMOTE_SERVER_API_PATHS.operatorAgentSessionsClearInactive, run: () => client.clearInactiveOperatorAgentSessions() },
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.operatorAgentSessionsSnoozeAndHidePanel }, expectedPath: REMOTE_SERVER_API_PATHS.operatorAgentSessionsSnoozeAndHidePanel, run: () => client.snoozeOperatorAgentSessionsAndHidePanel([sessionId]) },
      ...
      { route: { method: 'GET', path: REMOTE_SERVER_API_PATHS.conversationImageAsset }, expectedPath: REMOTE_SERVER_API_BUILDERS.conversationImageAsset(conversationId, imageFileName), run: () => client.getConversationImageAssetResponse(conversationId, imageFileName) },
      ...
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.conversationBranch }, expectedPath: REMOTE_SERVER_API_BUILDERS.conversationBranch(conversationId), run: () => client.branchConversation(conversationId, { messageIndex: 1 }) },
      { route: { method: 'DELETE', path: REMOTE_SERVER_API_PATHS.conversation }, expectedPath: REMOTE_SERVER_API_BUILDERS.conversation(conversationId), run: () => client.deleteConversation(conversationId) },
      { route: { method: 'DELETE', path: REMOTE_SERVER_API_PATHS.conversations }, expectedPath: REMOTE_SERVER_API_PATHS.conversations, run: () => client.deleteAllConversations() },
      ...
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.loopStartAll }, expectedPath: REMOTE_SERVER_API_PATHS.loopStartAll, run: () => client.startAllLoops() },
      { route: { method: 'POST', path: REMOTE_SERVER_API_PATHS.loopStopAll }, expectedPath: REMOTE_SERVER_API_PATHS.loopStopAll, run: () => client.stopAllLoops() },
