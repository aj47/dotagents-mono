...
test('renders delegated agent progress as compact desktop-style mobile chrome', () => {
  ...
  assert.match(delegationCardComponentSource, /<ChatMessageDelegationConversationPreviewRow\s+key=\{row\.key\}\s+\{\.\.\.row\.props\}/);
  ...
  assert.match(delegationCardComponentSource, /delegationCardParts\.conversationPreview\.moreAction\.shouldRender \? \(/);
  ...
  assert.match(delegationCardComponentSource, /<ChatMessageDelegationMorePreviewAction\s+\{\.\.\.delegationCardParts\.conversationPreview\.moreAction\.props\}/);
