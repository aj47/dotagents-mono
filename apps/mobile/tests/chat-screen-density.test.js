...
test('resolves mobile monospace typography from shared surface tokens', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /createChatRuntimeTurnDurationHeaderMobileStyleSlotVariants,/);
  ...
  assert.match(screenSource, /const headerTurnDurationStyleSlots = createChatRuntimeTurnDurationHeaderMobileStyleSlotVariants\(\{\s+renderState: headerChromeStyleState\.turnDuration,\s+platform: mobilePlatform,\s+\}\);/);
  assert.doesNotMatch(screenSource, /const createChatRuntimeMobileHeaderDurationTextStyle =/);
  assert.match(screenSource, /headerDurationChip:\s*\{[\s\S]*?\.\.\.headerTurnDurationStyleSlots\.standard\.chip/);
  assert.match(screenSource, /headerDurationChipText:\s*\{[\s\S]*?\.\.\.headerTurnDurationStyleSlots\.standard\.text/);
...
test('shows the shared total agent time in the mobile chat header', () => {
  ...
  assert.match(screenSource, /headerDurationChip:\s*\{[\s\S]*?\.\.\.headerTurnDurationStyleSlots\.standard\.chip/);
  assert.match(screenSource, /headerDurationChipLive:\s*\{[\s\S]*?\.\.\.headerTurnDurationStyleSlots\.live\.chip/);
  assert.match(screenSource, /headerDurationChipText:\s*\{[\s\S]*?\.\.\.headerTurnDurationStyleSlots\.standard\.text/);
  assert.match(screenSource, /headerDurationChipTextLive:\s*\{[\s\S]*?\.\.\.headerTurnDurationStyleSlots\.live\.text/);
