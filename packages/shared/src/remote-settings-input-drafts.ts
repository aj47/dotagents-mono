...
export function buildRemoteSettingsInputDrafts(
  ...
  return {
    ...
    chatgptWebAccessToken: getRemoteSettingsSecretInputDraft(settings.chatgptWebAccessToken, secretMask),
    chatgptWebSessionToken: getRemoteSettingsSecretInputDraft(settings.chatgptWebSessionToken, secretMask),
    chatgptWebBaseUrl: settings.chatgptWebBaseUrl || "",
