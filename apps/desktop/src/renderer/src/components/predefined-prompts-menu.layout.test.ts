...
describe("predefined prompts menu layout", () => {
  ...
  it("uses shared predefined prompt mutation helpers", () => {
    ...
    expect(predefinedPromptsMenuSource).toContain("getPromptLibraryEditorSaveActionState")
    expect(predefinedPromptsMenuSource).toContain("const editorSaveActionState = getPromptLibraryEditorSaveActionState")
    expect(predefinedPromptsMenuSource).toContain("disabled={editorSaveActionState.isDisabled}")
    expect(predefinedPromptsMenuSource).toContain("aria-label={editorSaveActionState.accessibilityLabel}")
