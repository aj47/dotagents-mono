...
test('uses tool activities wording consistently for grouped tool activity labels', () => {
  ...
  assert.match(chatRuntimeMobileStylesSource, /const chatMessageConversationThreadStyles = useMemo\(\s+\(\) => createChatMessageConversationThreadStyleSlots\(\{\s+threadSurfaceStyles: createChatMessageToolActivityGroupThreadSurfaceStyleSlots\(styles\),\s+threadBodyStyles: createChatMessageThreadBodyStyleSlots\(styles\),\s+actionStyles: createChatMessageActionStyleSlots\(\{\s+turnDurationStyles: \{/);
