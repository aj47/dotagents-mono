...
test('uses shared desktop-style icons for mobile composer controls', () => {
  ...
  assert.match(composerLabeledActionButtonSource, /if \(!actionButtonParts\.shouldRender\) return null;/);
...
test('uses desktop-style streaming response chrome while mobile assistant content is live', () => {
  ...
  assert.match(chatMessageChromeSource, /<Ionicons\s+\{\.\.\.expandedContentParts\.icon\.props\}/);
  assert.match(chatMessageChromeSource, /<Text\s+\{\.\.\.expandedContentParts\.title\.props\}>/);
  assert.match(chatMessageChromeSource, /\{expandedContentParts\.title\.text\}/);
  assert.match(chatMessageChromeSource, /<Image\s+\{\.\.\.expandedContentParts\.spinner\.props\}/);
  assert.match(chatMessageChromeSource, /<View\s+\{\.\.\.expandedContentParts\.badge\.props\}>/);
  assert.match(chatMessageChromeSource, /<Text\s+\{\.\.\.expandedContentParts\.badgeLabel\.props\}>/);
  ...
  assert.match(chatMessageChromeSource, /<Text\s+\{\.\.\.expandedContentParts\.text\.props\}>/);
  assert.match(chatMessageChromeSource, /\{expandedContentParts\.text\.text\}/);
  assert.match(chatMessageChromeSource, /<View\s+\{\.\.\.expandedContentParts\.caret\.props\} \/>/);
...
test('surfaces desktop step summaries as compact mobile runtime chrome without persisting them as messages', () => {
  ...
  assert.match(stepSummaryCardSource, /const stepSummaryCardContent = stepSummaryCardParts\.card\.content;/);
  ...
  assert.match(stepSummaryCardSource, /<View\s+\{\.\.\.stepSummaryCardParts\.card\.props\}>/);
