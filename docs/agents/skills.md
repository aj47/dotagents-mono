...
- **[Memory](memory.md)** — Persistent agent context
- **[Agent Profiles](profiles.md)** — Assign skills to agents
- **[The .agents Protocol](../concepts/dot-agents-protocol.md)** — Cross-tool compatibility
