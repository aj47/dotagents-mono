...
test('uses shared runtime presentation for mobile request and queue debug copy', () => {
  ...
  assert.match(screenSource, /createChatMessageRuntimeStartingRequestDebugState,/);
  assert.match(screenSource, /setDebugInfo\(createChatMessageRuntimeStartingRequestDebugState\(config\.baseUrl\)\.debugInfo\)/);
  assert.match(screenSource, /createChatMessageRuntimeRequestSentDebugState,/);
  assert.match(screenSource, /setDebugInfo\(createChatMessageRuntimeRequestSentDebugState\(\)\.debugInfo\)/);
  assert.match(screenSource, /createChatMessageRuntimeCompletedDebugState,/);
  assert.match(screenSource, /setDebugInfo\(createChatMessageRuntimeCompletedDebugState\(\)\.debugInfo\)/);
  assert.match(screenSource, /createChatMessageRuntimeProcessingQueuedMessageDebugState,/);
  assert.match(screenSource, /setDebugInfo\(createChatMessageRuntimeProcessingQueuedMessageDebugState\(\)\.debugInfo\)/);
  assert.match(screenSource, /const sessionChangedQueueFailureState = createChatMessageRuntimeSessionChangedDuringProcessingQueueFailureState\(\);/);
  ...
  assert.match(chatMessageChromeSource, /return createChatMessageRuntimeDebugInfoState\('completed'\)/);
  assert.match(chatMessageChromeSource, /export function createChatMessageRuntimeProcessingQueuedMessageDebugState\(\)/);
  assert.match(chatMessageChromeSource, /return createChatMessageRuntimeDebugInfoState\('processingQueuedMessage'\)/);
  assert.match(chatMessageChromeSource, /export function createChatMessageRuntimeSessionChangedDuringProcessingQueueFailureState\(\)/);
  assert.match(chatMessageChromeSource, /return createChatMessageRuntimeQueueFailureState\('sessionChangedDuringProcessing'\)/);
  assert.match(chatMessageChromeSource, /export function createChatMessageRuntimeRequestSupersededQueueFailureState\(\)/);
  assert.match(chatMessageChromeSource, /return createChatMessageRuntimeQueueFailureState\('requestSuperseded'\)/);
