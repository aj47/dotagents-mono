...
test('lets mobile respond to desktop tool approval requests from progress updates', () => {
  ...
  assert.match(sessionPresentationSource, /argumentsToggle: \{[\s\S]*?label: \{[\s\S]*?props: \{[\s\S]*?props: \{[\s\S]*?style: styles\.argumentsToggleText,[\s\S]*?text: renderState\.argumentsToggle\.label,/);
  ...
  assert.match(sessionPresentationSource, /denyButton: \{[\s\S]*?label: \{[\s\S]*?props: \{[\s\S]*?props: \{[\s\S]*?style: styles\.denyButtonText,[\s\S]*?text: renderState\.denyButton\.label,/);
  ...
  assert.match(sessionPresentationSource, /approveButton: \{[\s\S]*?label: \{[\s\S]*?props: \{[\s\S]*?props: \{[\s\S]*?style: styles\.approveButtonText,[\s\S]*?text: renderState\.approveButton\.label,/);
...
test('shows desktop-style retry status updates from shared runtime presentation', () => {
  ...
  assert.match(sessionPresentationSource, /attempt: \{[\s\S]*?props: \{[\s\S]*?style: styles\.attempt,[\s\S]*?text: renderState\.attemptLabel,/);
...
test('renders delegated agent progress as compact desktop-style mobile chrome', () => {
  ...
  assert.match(delegationCardComponentSource, /<ChatMessageDelegationHeader\s+\{\.\.\.delegationCardParts\.header\.props\}/);
  ...
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.conversationPreview\.rows\.map\(\(row\) => \([\s\S]*?style=\{row\.line\.style\}[\s\S]*?delegationCardParts\.conversationPreview\.moreAction/);
  ...
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationConversationPreview\([\s\S]*?moreAction\.shouldRender \? \([\s\S]*?<ChatMessageDelegationMorePreviewAction[\s\S]*?\{\.\.\.moreAction\.props\}/);
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.conversationPreview\.moreAction\.shouldRender \? \(/);
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.conversationPreview\.moreAction \? \(/);
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationMorePreviewAction/);
  assert.match(chatMessageChromeSource, /<ChatMessageDelegationMorePreviewAction\s+\{\.\.\.moreAction\.props\}/);
  ...
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.conversationPreview\.moreAction\.button\.accessibilityRole/);
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.conversationPreview\.moreAction\.button\.accessibilityLabel/);
  ...
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.conversationPreview\.moreAction\.label\.numberOfLines/);
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.conversationPreview\.moreAction\.label\.text/);
  ...
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationToolPreview\([\s\S]*?<ChatMessageDelegationToolPreviewLabel\s+\{\.\.\.label\.props\}/);
  assert.doesNotMatch(delegationCardComponentSource, /<ChatMessageDelegationToolPreviewLabel\s+\{\.\.\.delegationCardParts\.toolPreview\.label\.props\}/);
  ...
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.toolPreview\.rows\.map\(\(row\) =>/);
  ...
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationToolPreview\([\s\S]*?moreAction\.shouldRender \? \([\s\S]*?<ChatMessageDelegationMorePreviewAction[\s\S]*?\{\.\.\.moreAction\.props\}/);
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.toolPreview\.moreAction\.shouldRender \? \(/);
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.toolPreview\.moreAction \? \(/);
  assert.match(chatMessageChromeSource, /<ChatMessageDelegationMorePreviewAction\s+\{\.\.\.moreAction\.props\}/);
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.toolPreview\.moreAction\.button\.accessibilityRole/);
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.toolPreview\.moreAction\.button\.accessibilityLabel/);
  ...
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.toolPreview\.moreAction\.label\.numberOfLines/);
  assert.doesNotMatch(delegationCardComponentSource, /delegationCardParts\.toolPreview\.moreAction\.label\.text/);
...
test('uses shared runtime presentation for the mobile chat viewport and loading state', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageConversationRuntimeThreadList \{\.\.\.surfaceParts\.threadList\} \/>/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageConversationFrame[\s\S]*?keyboardAvoidingStyle=\{surfaceParts\.frame\.keyboardAvoidingStyle\}[\s\S]*?keyboardAvoidingBehavior=\{surfaceParts\.frame\.keyboardAvoidingBehavior\}[\s\S]*?keyboardVerticalOffset=\{surfaceParts\.frame\.keyboardVerticalOffset\}[\s\S]*?rootStyle=\{surfaceParts\.frame\.rootStyle\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageRuntimeDock\s+\{\.\.\.surfaceParts\.dock\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageRuntimeOverlays\s+\{\.\.\.surfaceParts\.overlays\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageRuntimeViewport\s+\{\.\.\.surfaceParts\.viewport\}/);
  assert.match(sessionPresentationSource, /frame: \{\s+\.\.\.frame,\s+keyboardAvoidingStyle: styles\.frame\.keyboardAvoidingStyle,\s+rootStyle: styles\.frame\.rootStyle,\s+\}/);
  assert.match(sessionPresentationSource, /dock: \{\s+\.\.\.dock,\s+styles: styles\.dock,\s+\}/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageConversationViewport\s+\{\.\.\.scrollViewportProps\}\s+\{\.\.\.viewportParts\.scrollViewport\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageLoadingState\s+\{\.\.\.viewportParts\.loadingState\}/);
  assert.match(chatMessageChromeSource, /<ChatConversationHomeQuickStarts\s+\{\.\.\.viewportParts\.homeQuickStarts\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageHistoryBanner\s+\{\.\.\.viewportParts\.historyBanner\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageStepSummaryCard\s+\{\.\.\.viewportParts\.stepSummary\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageDebugPanelStack\s+\{\.\.\.viewportParts\.debugPanels\}/);
  assert.match(sessionPresentationSource, /scrollViewport: \{\s+style: styles\.scrollViewport\.style,\s+contentContainerStyle: styles\.scrollViewport\.contentContainerStyle,\s+\}/);
  assert.match(sessionPresentationSource, /loadingState: \{\s+\.\.\.loadingState,\s+style: styles\.loadingState\.style,\s+spinnerStyle: styles\.loadingState\.spinnerStyle,\s+\}/);
...
test('uses shared desktop-style icons for mobile composer controls', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatComposerPendingImagesRail\s+\{\.\.\.composerDockParts\.pendingImagesRail\}/);
  assert.match(chatMessageChromeSource, /<ChatComposerHandsFreeControls\s+\{\.\.\.composerDockParts\.handsFreeControls\}\s+status=\{<HandsFreeStatusChip \{\.\.\.composerDockParts\.handsFreeStatus\} \/>\}/);
  assert.match(chatMessageChromeSource, /<ChatComposerIconButton\s+\{\.\.\.composerDockParts\.imageAttachmentControl\}/);
  assert.match(chatMessageChromeSource, /<ChatComposerIconButton\s+\{\.\.\.composerDockParts\.textToSpeechControl\}/);
  assert.match(chatMessageChromeSource, /<ChatComposerIconButton\s+\{\.\.\.composerDockParts\.editBeforeSendControl\}/);
  assert.match(chatMessageChromeSource, /<ChatComposerTextEntry\s+\{\.\.\.composerDockParts\.textEntry\}/);
  ...
  assert.match(chatMessageChromeSource, /<ChatComposerMicButton\s+\{\.\.\.composerDockParts\.micButton\}/);
  assert.match(chatMessageChromeSource, /\{\.\.\.composerDockParts\.inputDock\}/);
  ...
  assert.match(sessionPresentationSource, /imageAttachmentControl: \{\s+\.\.\.imageAttachmentControl,\s+style: styles\.accessoryButton\.style,\s+activeStyle: styles\.accessoryButton\.activeStyle,\s+\}/);
  ...
  assert.match(chatMessageChromeSource, /<ChatComposerLabeledActionButton\s+\{\.\.\.composerDockParts\.queueAction\}/);
  assert.match(sessionPresentationSource, /queueAction: \{\s+\.\.\.queueAction,\s+styles: styles\.queueAction,\s+\}/);
  ...
  assert.match(chatMessageChromeSource, /<ChatComposerLabeledActionButton\s+\{\.\.\.composerDockParts\.submitAction\}/);
  assert.match(sessionPresentationSource, /submitAction: \{\s+\.\.\.submitAction,\s+styles: styles\.submitAction,\s+\}/);
  ...
  assert.match(chatMessageChromeSource, /<ChatComposerTextEntry\s+\{\.\.\.composerDockParts\.textEntry\}/);
  assert.match(sessionPresentationSource, /textEntry: \{\s+\.\.\.textEntry,\s+styles: styles\.textEntry,\s+\}/);
...
test('uses shared mobile icon chrome for pending image removal', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatComposerPendingImagesRail\s+\{\.\.\.composerDockParts\.pendingImagesRail\}/);
  assert.match(sessionPresentationSource, /pendingImagesRail: \{\s+\.\.\.pendingImagesRail,\s+styles: styles\.pendingImagesRail,\s+\}/);
...
test('lets mobile branch linked desktop conversations from individual messages', () => {
  ...
  assert.match(chatMessageChromeSource, /actionIconButtonParts\.activityIndicator\.shouldRender \? \(/);
