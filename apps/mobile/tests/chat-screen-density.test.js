...
test('uses shared runtime presentation for mobile connection and retry banners', () => {
  ...
  assert.match(connectionBannerSource, /const reconnectingContent = reconnecting\.container\.content;/);
  assert.match(connectionBannerSource, /const reconnectingBodyContent = reconnectingContent\.body\.content;/);
  assert.match(connectionBannerSource, /const reconnectingTextContent = reconnectingBodyContent\.textContainer\.content;/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerContainer\s+\{\.\.\.reconnecting\.container\.props\}/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerContent\s+\{\.\.\.reconnectingContent\.body\.props\}/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerSpinner\s+\{\.\.\.reconnectingBodyContent\.spinner\.props\}/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerTextContainer\s+\{\.\.\.reconnectingBodyContent\.textContainer\.props\}/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerText\s+\{\.\.\.reconnectingTextContent\.title\.props\}/);
  assert.match(connectionBannerSource, /reconnectingTextContent\.subtitle\.shouldRender \? \(/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerText\s+\{\.\.\.reconnectingTextContent\.subtitle\.props\}/);
  ...
  assert.match(connectionBannerSource, /const failedContent = failed\.container\.content;/);
  assert.match(connectionBannerSource, /const failedBodyContent = failedContent\.body\.content;/);
  assert.match(connectionBannerSource, /const failedTextContent = failedBodyContent\.textContainer\.content;/);
  assert.match(connectionBannerSource, /const failedRetryButtonContent = failedBodyContent\.retryButton\.content;/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerContainer\s+\{\.\.\.failed\.container\.props\}/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerContent\s+\{\.\.\.failedContent\.body\.props\}/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerIcon\s+\{\.\.\.failedBodyContent\.icon\.props\}/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerTextContainer\s+\{\.\.\.failedBodyContent\.textContainer\.props\}/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerText\s+\{\.\.\.failedTextContent\.title\.props\}/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerText\s+\{\.\.\.failedTextContent\.subtitle\.props\}/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerRetryButton\s+\{\.\.\.failedBodyContent\.retryButton\.props\}/);
  assert.match(connectionBannerSource, /<ChatMessageConnectionBannerText\s+\{\.\.\.failedRetryButtonContent\.label\.props\}/);
