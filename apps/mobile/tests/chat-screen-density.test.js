...
test('shows desktop-style retry status updates from shared runtime presentation', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageRetryStatusHeader\s+header=\{retryStatusContent\.header\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageRetryStatusMeta\s+meta=\{retryStatusContent\.meta\}/);
  assert.match(retryStatusSource, /export function ChatMessageRetryStatusHeader/);
  assert.match(retryStatusSource, /const headerContent = header\.content;/);
  ...
  assert.match(retryStatusSource, /const metaContent = meta\.content;/);
  assert.match(retryStatusSource, /<ChatMessageRetryStatusView\s+\{\.\.\.meta\.props\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageRetryStatusText\s+\{\.\.\.metaContent\.attempt\.props\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageRetryStatusText\s+\{\.\.\.metaContent\.countdown\.props\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageRetryStatusText\s+\{\.\.\.retryStatusContent\.description\.props\}/);
