...
test('renders delegated agent progress as compact desktop-style mobile chrome', () => {
  ...
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationHeader[\s\S]*?liveText\.shouldRender \? \([\s\S]*?<Text\s+\{\.\.\.liveText\.props\}[\s\S]*?\{liveText\.text\}[\s\S]*?export function ChatMessageDelegationMetaItem/);
  ...
  assert.match(delegationCardComponentSource, /cardContent\.subtitle\.shouldRender \? \(/);
  ...
  assert.match(delegationCardComponentSource, /<ChatMessageDelegationSubtitle\s+\{\.\.\.cardContent\.subtitle\.props\}/);
  ...
  assert.match(delegationCardComponentSource, /cardContent\.conversationPreview\.shouldRender \? \(/);
  ...
  assert.match(delegationCardComponentSource, /<ChatMessageDelegationConversationPreview\s+\{\.\.\.cardContent\.conversationPreview\.props\}/);
  ...
  assert.match(delegationCardComponentSource, /cardContent\.toolPreview\.shouldRender \? \(/);
  ...
  assert.match(delegationCardComponentSource, /<ChatMessageDelegationToolPreview\s+\{\.\.\.cardContent\.toolPreview\.props\}/);
