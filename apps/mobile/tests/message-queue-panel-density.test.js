...
test('mobile queued-message rows use text-first actions with explicit accessibility labels', () => {
  ...
  assert.match(source, /disabled=\{editDraftState\.saveActionState\.isDisabled\}/);
  assert.match(source, /accessibilityState=\{editDraftState\.saveActionState\.accessibilityState\}/);
