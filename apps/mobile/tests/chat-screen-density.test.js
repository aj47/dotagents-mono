...
test('uses shared media sanitization for collapsed mobile message previews', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageCollapsedPreview\s+\{\.\.\.conversationContentParts\.collapsedContent\.props\.preview\}/);
...
test('uses desktop-style streaming response chrome while mobile assistant content is live', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageExpandedContent\s+\{\.\.\.conversationContentParts\.expandedContent\.props\.content\}/);
...
test('uses tool activities wording consistently for grouped tool activity labels', () => {
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageThreadItem\s+\{\.\.\.threadSurfaceParts\.item\}[\s\S]*?<ChatMessageSurface\s+\{\.\.\.threadSurfaceParts\.surface\}/);
...
test('keeps the TTS control inline with assistant message text instead of on a detached row', () => {
  ...
  assert.match(chatScreenSource, /\.\.\.chatRuntimeChrome\.messageRuntime,/);
  assert.doesNotMatch(chatScreenSource, /threadList: \{[\s\S]*?threadStyles: chatMessageConversationThreadStyles\.runtimeThread,/);
  assert.match(chatMessageChromeSource, /<ChatMessageThreadBody\s+\{\.\.\.resolvedBody\}\s+styles=\{runtimeThreadParts\.bodySurface\.bodyStyles\}/);
  assert.match(sessionPresentationSource, /createBodyState: getChatRuntimeConversationThreadBodyMobileState,/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageContentRow\s+\{\.\.\.conversationContentParts\.expandedContent\.props\.row\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageExpandedContent\s+\{\.\.\.conversationContentParts\.expandedContent\.props\.content\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageContentRow\s+\{\.\.\.conversationContentParts\.collapsedContent\.props\.row\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageCollapsedPreview\s+\{\.\.\.conversationContentParts\.collapsedContent\.props\.preview\}/);
