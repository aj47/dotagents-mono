...
test('replaces the empty mobile chat home state with quick-start launchers', () => {
  ...
  assert.match(chatMessageChromeSource, /<View \{\.\.\.item\.sourcePill\.props\}>/);
  assert.match(chatMessageChromeSource, /<Ionicons \{\.\.\.item\.sourcePill\.icon\.props\} \/>/);
  ...
  assert.match(chatMessageChromeSource, /<Text \{\.\.\.item\.sourcePill\.label\.props\}>/);
  assert.match(chatMessageChromeSource, /item\.addIcon\.shouldRender \? \(/);
  assert.doesNotMatch(chatMessageChromeSource, /item\.addIcon \? \(/);
  assert.match(chatMessageChromeSource, /<Ionicons \{\.\.\.item\.addIcon\.props\} \/>/);
