...
test('renders delegated agent progress as compact desktop-style mobile chrome', () => {
  ...
  assert.match(screenSource, /const delegationAccessibilityLabel = m\.delegation && delegationPresentation\s+\? formatChatRuntimeDelegationAccessibilityLabel\(/);
  assert.match(screenSource, /delegationCard: createChatMessageDelegationCardProps\(\{\s+isDelegation: m\.variant === 'delegation',\s+surface: mobileRuntimeDelegationCard,\s+agentName: m\.delegation\?\.agentName,/);
  assert.match(screenSource, /presentation: delegationPresentation/);
  assert.match(screenSource, /accessibilityLabel: delegationAccessibilityLabel/);
  ...
  assert.match(chatMessageChromeSource, /return isDelegation && presentation\s+\? \{/);
