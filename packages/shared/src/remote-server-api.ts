...
export const REMOTE_SERVER_API_PATHS = {
  ...
  operatorChatGptWebAuth: "/operator/providers/chatgpt-web/auth",
  operatorChatGptWebAuthLogin: "/operator/providers/chatgpt-web/auth/login",
  operatorChatGptWebAuthLogout: "/operator/providers/chatgpt-web/auth/logout",
  ...
  operatorStopTtsPlayback: "/operator/actions/stop-tts",
  operatorDesktopMainWindowShow: "/operator/windows/main/show",
  operatorDesktopPanelWindowShow: "/operator/windows/panel/show",
  operatorDesktopPanelWindowHide: "/operator/windows/panel/hide",
  operatorDesktopPanelWindowReset: "/operator/windows/panel/reset",
  ...
  operatorAgentSessionsSnoozeAndHidePanel: "/operator/sessions/snooze-and-hide-panel",
  ...
  bundleExportableItems: "/bundles/exportable-items",
  bundleExport: "/bundles/export",
  bundleImportPreview: "/bundles/import/preview",
  bundleImport: "/bundles/import",
  ...
  conversationBranch: "/conversations/:id/branch",
  ...
  skills: "/skills",
  skill: "/skills/:id",
  skillImportMarkdown: "/skills/import/markdown",
  skillImportGitHub: "/skills/import/github",
  skillsDeleteMultiple: "/skills/delete-multiple",
  skillExportMarkdown: "/skills/:id/export/markdown",
  skillToggleProfile: "/skills/:id/toggle-profile",
  knowledgeNotes: "/knowledge/notes",
  knowledgeNotesSearch: "/knowledge/notes/search",
  knowledgeNotesDeleteMultiple: "/knowledge/notes/delete-multiple",
  knowledgeNotesDeleteAll: "/knowledge/notes/delete-all",
  knowledgeNote: "/knowledge/notes/:id",
  agentProfiles: "/agent-profiles",
  agentProfileVerifyCommand: "/agent-profiles/verify-command",
  agentProfilesReload: "/agent-profiles/reload",
  ...
  loopStartAll: "/loops/start-all",
  loopStopAll: "/loops/stop-all",
...
export const REMOTE_SERVER_API_ROUTES = [
  ...
  { method: "GET", path: REMOTE_SERVER_API_PATHS.operatorChatGptWebAuth },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.operatorChatGptWebAuthLogin },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.operatorChatGptWebAuthLogout },
  ...
  { method: "POST", path: REMOTE_SERVER_API_PATHS.operatorStopTtsPlayback },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.operatorDesktopMainWindowShow },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.operatorDesktopPanelWindowShow },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.operatorDesktopPanelWindowHide },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.operatorDesktopPanelWindowReset },
  ...
  { method: "POST", path: REMOTE_SERVER_API_PATHS.operatorAgentSessionsSnoozeAndHidePanel },
  ...
  { method: "GET", path: REMOTE_SERVER_API_PATHS.bundleExportableItems },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.bundleExport },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.bundleImportPreview },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.bundleImport },
  ...
  { method: "GET", path: REMOTE_SERVER_API_PATHS.mcpConfigExport },
  ...
  { method: "DELETE", path: REMOTE_SERVER_API_PATHS.conversations },
  { method: "PUT", path: REMOTE_SERVER_API_PATHS.conversation },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.conversationBranch },
  { method: "DELETE", path: REMOTE_SERVER_API_PATHS.conversation },
  ...
  { method: "POST", path: REMOTE_SERVER_API_PATHS.skillImportMarkdown },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.skillImportGitHub },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.skillsDeleteMultiple },
  { method: "GET", path: REMOTE_SERVER_API_PATHS.skillExportMarkdown },
  ...
  { method: "POST", path: REMOTE_SERVER_API_PATHS.knowledgeNotesSearch },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.knowledgeNotesDeleteMultiple },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.knowledgeNotesDeleteAll },
  ...
  { method: "POST", path: REMOTE_SERVER_API_PATHS.agentProfileVerifyCommand },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.agentProfilesReload },
  ...
  { method: "POST", path: REMOTE_SERVER_API_PATHS.loopStartAll },
  { method: "POST", path: REMOTE_SERVER_API_PATHS.loopStopAll },
...
export const REMOTE_SERVER_API_BUILDERS = {
  ...
  operatorAgentSessionSnooze(sessionId: string): string {
    return `/operator/sessions/${encodePathParam(sessionId)}/snooze`;
  },
  ...
  conversationBranch(id: string): string {
    return `/conversations/${encodePathParam(id)}/branch`;
  },
  ...
  skillExportMarkdown(skillId: string): string {
    return `/skills/${encodePathParam(skillId)}/export/markdown`;
  },
