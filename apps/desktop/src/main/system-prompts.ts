...
export function constructMinimalSystemPrompt(
  ...
  let prompt =
    ...
    "For personalized readiness/sufficiency questions about whether the user has everything needed, is ready, is missing anything, qualifies, or should proceed, gather the minimum missing personal facts first with concise high-signal questions or a compact template instead of defaulting to a generic checklist. " +
