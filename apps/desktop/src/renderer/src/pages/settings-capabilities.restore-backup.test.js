...
test('main process offers backup picker and reveal actions rooted in the default backup directory', () => {
  ...
  assert.match(bundleServiceSource, /function createImportBackupMetadata\([\s\S]*targetAgentsDir: string,[\s\S]*targetLayer\?: BundleBackupTargetLayer[\s\S]*\): BundleBackupMetadata/)
  assert.match(bundleServiceSource, /backupMetadata: createImportBackupMetadata\(targetAgentsDir, targetLayer\)/)
