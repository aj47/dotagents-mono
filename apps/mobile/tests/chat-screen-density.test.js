...
test('renders delegated agent progress as compact desktop-style mobile chrome', () => {
  ...
  assert.match(sessionPresentationSource, /header: \{[\s\S]*?props: \{[\s\S]*?container: \{[\s\S]*?style: styles\.header,/);
  ...
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationHeader[\s\S]*?numberOfLines=\{title\.numberOfLines\}[\s\S]*?\{title\.text\}[\s\S]*?export function ChatMessageDelegationMetaItem/);
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationHeader[\s\S]*?numberOfLines=\{statusText\.numberOfLines\}[\s\S]*?\{statusText\.text\}[\s\S]*?export function ChatMessageDelegationMetaItem/);
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationHeader[\s\S]*?liveText\.shouldRender \? \([\s\S]*?\{liveText\.text\}[\s\S]*?export function ChatMessageDelegationMetaItem/);
  ...
  assert.match(sessionPresentationSource, /items: metaItems\.map\(\(item\) => \(\{[\s\S]*?key: item\.key,[\s\S]*?props: \{[\s\S]*?numberOfLines: surface\.metaNumberOfLines,/);
  ...
  assert.match(sessionPresentationSource, /key: `\$\{row\.timestamp\}-\$\{row\.role\}-\$\{rowIndex\}`,[\s\S]*?props: \{[\s\S]*?line: \{[\s\S]*?style: styles\.conversationPreviewLine,/);
  ...
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationConversationPreviewRow[\s\S]*?style=\{role\.style\}[\s\S]*?numberOfLines=\{role\.numberOfLines\}[\s\S]*?ellipsizeMode=\{role\.ellipsizeMode\}[\s\S]*?export function ChatMessageDelegationCard/);
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationConversationPreviewRow[\s\S]*?style=\{content\.style\}[\s\S]*?numberOfLines=\{content\.numberOfLines\}[\s\S]*?ellipsizeMode=\{content\.ellipsizeMode\}[\s\S]*?export function ChatMessageDelegationCard/);
  ...
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationConversationPreviewRow[\s\S]*?timestamp\.shouldRender \? \([\s\S]*?export function ChatMessageDelegationCard/);
  ...
  assert.match(sessionPresentationSource, /shouldRenderConversationPreview && conversationPreview\.hiddenCount > 0 && conversationPreview\.onShowAll \? \{[\s\S]*?shouldRender: true,[\s\S]*?props: \{[\s\S]*?button: \{/);
  ...
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationMorePreviewAction[\s\S]*?accessibilityRole=\{button\.accessibilityRole\}[\s\S]*?accessibilityLabel=\{button\.accessibilityLabel\}[\s\S]*?export function ChatMessageDelegationCard/);
  ...
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationMorePreviewAction[\s\S]*?numberOfLines=\{label\.numberOfLines\}[\s\S]*?\{label\.text\}[\s\S]*?export function ChatMessageDelegationCard/);
  ...
  assert.match(sessionPresentationSource, /rows: shouldRenderToolPreview \? toolPreview\.rows\.map\(\(\{ key, preview, renderState \}\) => \(\{[\s\S]*?key,[\s\S]*?props: \{[\s\S]*?line: \{[\s\S]*?style: styles\.toolPreviewLine,/);
  ...
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationToolPreviewRow[\s\S]*?accessibilityLabel=\{line\.accessibilityLabel\}[\s\S]*?export function ChatMessageDelegationCard/);
  ...
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationToolPreviewRow[\s\S]*?statusIcon\.spinner\.shouldRender \? \([\s\S]*?size=\{statusIcon\.spinner\.size\}[\s\S]*?color=\{statusIcon\.spinner\.color\}[\s\S]*?export function ChatMessageDelegationCard/);
  assert.match(sessionPresentationSource, /renderState\.statusIndicator\.icon\.shouldRender/);
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationToolPreviewRow[\s\S]*?statusIcon\.icon\.shouldRender \? \([\s\S]*?name=\{statusIcon\.icon\.name\}[\s\S]*?color=\{statusIcon\.icon\.color\}[\s\S]*?export function ChatMessageDelegationCard/);
  ...
  assert.match(chatMessageChromeSource, /export function ChatMessageDelegationToolPreviewRow[\s\S]*?numberOfLines=\{name\.numberOfLines\}[\s\S]*?ellipsizeMode=\{name\.ellipsizeMode\}[\s\S]*?export function ChatMessageDelegationCard/);
  ...
  assert.match(sessionPresentationSource, /onShowAll: \(\) => onShowAllToolPreview\(presentationState\.runId\),/);
  assert.match(sessionPresentationSource, /shouldRenderToolPreview && toolPreview\.hiddenCount > 0 && toolPreview\.onShowAll \? \{[\s\S]*?shouldRender: true,[\s\S]*?props: \{[\s\S]*?button: \{/);
...
test('uses shared runtime presentation for mobile scroll-to-bottom affordance', () => {
  ...
  assert.match(chatMessageChromeSource, /style=\{scrollToBottomButtonParts\.button\.style\}/);
  assert.match(chatMessageChromeSource, /onPress=\{scrollToBottomButtonParts\.button\.onPress\}/);
  assert.match(chatMessageChromeSource, /activeOpacity=\{scrollToBottomButtonParts\.button\.activeOpacity\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{scrollToBottomButtonParts\.button\.accessibilityRole\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{scrollToBottomButtonParts\.button\.accessibilityLabel\}/);
  assert.match(chatMessageChromeSource, /accessibilityHint=\{scrollToBottomButtonParts\.button\.accessibilityHint\}/);
  assert.match(chatMessageChromeSource, /name=\{scrollToBottomButtonParts\.icon\.name\}/);
  assert.match(chatMessageChromeSource, /size=\{scrollToBottomButtonParts\.icon\.size\}/);
  assert.match(chatMessageChromeSource, /color=\{scrollToBottomButtonParts\.icon\.color\}/);
...
test('uses shared desktop-style icons for mobile composer controls', () => {
  ...
  assert.match(inputDockSource, /<View style=\{inputDockParts\.area\.style\}>/);
  ...
  assert.match(inputDockSource, /<View style=\{inputDockParts\.row\.style\}>/);
  ...
  assert.match(inputDockSource, /ref=\{inputDockParts\.micWrapper\.ref\}/);
  assert.match(inputDockSource, /style=\{inputDockParts\.micWrapper\.style\}/);
...
test('uses shared mobile icon chrome for pending image removal', () => {
  ...
  assert.match(pendingImagesRailSource, /horizontal=\{pendingImagesRailParts\.scrollView\.horizontal\}/);
  assert.match(pendingImagesRailSource, /showsHorizontalScrollIndicator=\{pendingImagesRailParts\.scrollView\.showsHorizontalScrollIndicator\}/);
  assert.match(pendingImagesRailSource, /contentContainerStyle=\{pendingImagesRailParts\.scrollView\.contentContainerStyle\}/);
  assert.match(pendingImagesRailSource, /pendingImagesRailParts\.items\.map\(\(item\) =>/);
  assert.match(pendingImagesRailSource, /<View key=\{item\.key\} style=\{item\.card\.style\}>/);
  assert.match(pendingImagesRailSource, /source=\{item\.preview\.source\}/);
  assert.match(pendingImagesRailSource, /style=\{item\.preview\.style\}/);
  assert.match(pendingImagesRailSource, /onPress=\{item\.removeButton\.onPress\}/);
  assert.match(pendingImagesRailSource, /activeOpacity=\{item\.removeButton\.activeOpacity\}/);
  assert.match(pendingImagesRailSource, /accessibilityRole=\{item\.removeButton\.accessibilityRole\}/);
  assert.match(pendingImagesRailSource, /accessibilityLabel=\{item\.removeButton\.accessibilityLabel\}/);
  assert.match(pendingImagesRailSource, /name=\{item\.removeIcon\.name\}/);
  assert.match(pendingImagesRailSource, /size=\{item\.removeIcon\.size\}/);
  assert.match(pendingImagesRailSource, /color=\{item\.removeIcon\.color\}/);
...
test('derives tool execution card status from displayed non-meta tool entries', () => {
  ...
  assert.match(chatMessageChromeSource, /const panelShellParts = createChatRuntimeToolExecutionPanelShellMobilePropsParts\(\{\s+compactList: \([\s\S]*?<ChatMessageToolExecutionCompactList[\s\S]*?\{\.\.\.panelParts\.compact\}[\s\S]*?expandedGroup: panelParts\.expandedGroup\.shouldRender \? \([\s\S]*?<ChatMessageToolExecutionExpandedGroup \{\.\.\.panelParts\.expandedGroup\.props\}>/);
  ...
  assert.match(chatMessageChromeSource, /style=\{compactRowParts\.container\.style\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{compactRowParts\.container\.accessibilityLabel\}/);
  ...
  assert.match(chatMessageChromeSource, /style=\{compactRowParts\.leadingIcon\.style\}/);
  assert.match(chatMessageChromeSource, /name=\{compactRowParts\.leadingIcon\.icon\.name\}/);
  assert.match(chatMessageChromeSource, /size=\{compactRowParts\.leadingIcon\.icon\.size\}/);
  assert.match(chatMessageChromeSource, /color=\{compactRowParts\.leadingIcon\.icon\.color\}/);
  assert.match(chatMessageChromeSource, /style=\{compactRowParts\.name\.style\}/);
  assert.match(chatMessageChromeSource, /numberOfLines=\{compactRowParts\.name\.numberOfLines\}/);
  ...
  assert.match(chatMessageChromeSource, /style=\{compactRowParts\.toggleIcon\.style\}/);
  assert.match(chatMessageChromeSource, /name=\{compactRowParts\.toggleIcon\.icon\.name\}/);
  assert.match(chatMessageChromeSource, /size=\{compactRowParts\.toggleIcon\.icon\.size\}/);
  assert.match(chatMessageChromeSource, /color=\{compactRowParts\.toggleIcon\.icon\.color\}/);
  ...
  assert.match(chatMessageChromeSource, /<View style=\{expandedGroupParts\.containerStyle\}>/);
  ...
  assert.match(sessionPresentationSource, /cardStyle: \[\s+styles\.card,\s+isPending && styles\.pending,\s+allSuccess && styles\.success,\s+hasErrors && styles\.error,\s+\]/);
  ...
  assert.match(chatMessageChromeSource, /onPress=\{collapseControlParts\.container\.onPress\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{collapseControlParts\.container\.accessibilityRole\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{collapseControlParts\.container\.accessibilityLabel\}/);
  assert.match(chatMessageChromeSource, /accessibilityHint=\{collapseControlParts\.container\.accessibilityHint\}/);
  assert.match(chatMessageChromeSource, /style=\{collapseControlParts\.container\.style\}/);
  assert.match(chatMessageChromeSource, /name=\{collapseControlParts\.icon\.name\}/);
  assert.match(chatMessageChromeSource, /size=\{collapseControlParts\.icon\.size\}/);
  assert.match(chatMessageChromeSource, /color=\{collapseControlParts\.icon\.color\}/);
  assert.match(chatMessageChromeSource, /style=\{collapseControlParts\.label\.style\}/);
  assert.match(chatMessageChromeSource, /\{collapseControlParts\.label\.text\}/);
  assert.match(sessionPresentationSource, /style: \(\{ pressed \}\) => \[\s+styles\.button,\s+pressed && styles\.pressed,\s+styles\.placement,/);
  ...
  assert.match(chatMessageChromeSource, /onPress=\{copyButtonParts\.container\.onPress\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{copyButtonParts\.container\.accessibilityRole\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{copyButtonParts\.container\.accessibilityLabel\}/);
  assert.match(chatMessageChromeSource, /style=\{copyButtonParts\.container\.style\}/);
  assert.match(chatMessageChromeSource, /name=\{copyButtonParts\.icon\.name\}/);
  assert.match(chatMessageChromeSource, /size=\{copyButtonParts\.icon\.size\}/);
  assert.match(chatMessageChromeSource, /color=\{copyButtonParts\.icon\.color\}/);
  assert.match(chatMessageChromeSource, /style=\{copyButtonParts\.label\.style\}/);
  assert.match(chatMessageChromeSource, /\{copyButtonParts\.label\.text\}/);
  assert.match(sessionPresentationSource, /style: \(\{ pressed \}\) => \[\s+styles\.button,\s+pressed && styles\.pressed,/);
  ...
  assert.match(chatMessageChromeSource, /accessible=\{pendingResultParts\.container\.accessible\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{pendingResultParts\.container\.accessibilityRole\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{pendingResultParts\.container\.accessibilityLabel\}/);
  assert.match(chatMessageChromeSource, /style=\{pendingResultParts\.container\.style\}/);
  assert.match(chatMessageChromeSource, /size=\{pendingResultParts\.spinner\.size\}/);
  assert.match(chatMessageChromeSource, /color=\{pendingResultParts\.spinner\.color\}/);
  assert.match(chatMessageChromeSource, /style=\{pendingResultParts\.label\.style\}/);
  assert.match(chatMessageChromeSource, /\{pendingResultParts\.label\.text\}/);
  ...
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionCallSection\s+\{\.\.\.callDetailParts\.callSection\}/);
  assert.match(sessionPresentationSource, /callSection: \{\s+renderState,\s+toolName,\s+onHeaderPress,\s+styles: styles\.callSection,/);
  ...
  assert.match(chatMessageChromeSource, /onPress=\{detailHeaderParts\.container\.onPress\}/);
  assert.match(chatMessageChromeSource, /style=\{detailHeaderParts\.container\.style\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{detailHeaderParts\.container\.accessibilityRole\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{detailHeaderParts\.container\.accessibilityLabel\}/);
  assert.match(chatMessageChromeSource, /accessibilityState=\{detailHeaderParts\.container\.accessibilityState\}/);
  assert.match(chatMessageChromeSource, /aria-expanded=\{detailHeaderParts\.container\.ariaExpanded\}/);
  ...
  assert.match(chatMessageChromeSource, /accessibilityHint=\{detailHeaderParts\.container\.accessibilityHint\}/);
  assert.match(chatMessageChromeSource, /style=\{detailHeaderParts\.toolName\.style\}/);
  assert.match(chatMessageChromeSource, /\{detailHeaderParts\.toolName\.text\}/);
  assert.match(chatMessageChromeSource, /style=\{detailHeaderParts\.expandHint\.style\}/);
  assert.match(chatMessageChromeSource, /name=\{detailHeaderParts\.expandHint\.icon\.name\}/);
  assert.match(chatMessageChromeSource, /size=\{detailHeaderParts\.expandHint\.icon\.size\}/);
  assert.match(chatMessageChromeSource, /color=\{detailHeaderParts\.expandHint\.icon\.color\}/);
  assert.match(chatMessageChromeSource, /style=\{detailHeaderParts\.expandHint\.label\.style\}/);
  assert.match(chatMessageChromeSource, /\{detailHeaderParts\.expandHint\.label\.text\}/);
  ...
  assert.match(chatMessageChromeSource, /<View style=\{resultHeaderParts\.headerStyle\}>/);
  assert.match(chatMessageChromeSource, /<View style=\{resultHeaderParts\.metaStyle\}>/);
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionPayloadMeta\s+\{\.\.\.resultHeaderParts\.payloadMeta\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionResultBadge\s+\{\.\.\.resultHeaderParts\.resultBadge\}/);
  assert.match(chatMessageChromeSource, /style=\{resultHeaderParts\.characterCount\.style\}/);
  assert.match(chatMessageChromeSource, /\{resultHeaderParts\.characterCount\.label\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionCopyButton\s+\{\.\.\.resultHeaderParts\.copyButton\}/);
  assert.match(sessionPresentationSource, /resultBadge: \{\s+badge: resultBadge,\s+styles: styles\.badge,/);
  assert.match(sessionPresentationSource, /characterCount: \{\s+label: characterCountLabel,\s+style: styles\.characterCount,/);
  ...
  assert.match(chatMessageChromeSource, /accessible=\{resultBadgeParts\.container\.accessible\}/);
  assert.match(chatMessageChromeSource, /accessibilityRole=\{resultBadgeParts\.container\.accessibilityRole\}/);
  assert.match(chatMessageChromeSource, /accessibilityLabel=\{resultBadgeParts\.container\.accessibilityLabel\}/);
  assert.match(chatMessageChromeSource, /style=\{resultBadgeParts\.container\.style\}/);
  assert.match(chatMessageChromeSource, /name=\{resultBadgeParts\.icon\.name\}/);
  assert.match(chatMessageChromeSource, /size=\{resultBadgeParts\.icon\.size\}/);
  assert.match(chatMessageChromeSource, /color=\{resultBadgeParts\.icon\.color\}/);
  assert.match(chatMessageChromeSource, /style=\{resultBadgeParts\.label\.style\}/);
  assert.match(chatMessageChromeSource, /\{resultBadgeParts\.label\.text\}/);
  ...
  assert.match(chatMessageChromeSource, /<View style=\{payloadSectionParts\.sectionStyle\}>/);
  assert.match(chatMessageChromeSource, /<View style=\{payloadSectionParts\.headerRowStyle\}>/);
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionPayloadMeta\s+\{\.\.\.payloadSectionParts\.payloadMeta\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionCopyButton\s+\{\.\.\.payloadSectionParts\.copyButton\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionPayloadBlock\s+\{\.\.\.payloadSectionParts\.payloadBlock\}/);
  assert.match(sessionPresentationSource, /payloadMeta: \{\s+renderState: payloadRenderState,\s+styles: styles\.payloadMeta,/);
  assert.match(sessionPresentationSource, /payloadBlock: \{\s+compactText,\s+content,\s+isExpanded,\s+previewNumberOfLines,\s+styles: styles\.payloadBlock,/);
  ...
  assert.match(chatMessageChromeSource, /<View style=\{errorBlockParts\.sectionStyle\}>/);
  assert.match(chatMessageChromeSource, /<View style=\{errorBlockParts\.headerRowStyle\}>/);
  assert.match(chatMessageChromeSource, /style=\{errorBlockParts\.label\.style\}/);
  assert.match(chatMessageChromeSource, /\{errorBlockParts\.label\.text\}/);
  assert.match(chatMessageChromeSource, /<ChatMessageToolExecutionCopyButton\s+\{\.\.\.errorBlockParts\.copyButton\}/);
  assert.match(chatMessageChromeSource, /style=\{errorBlockParts\.error\.style\}/);
  assert.match(chatMessageChromeSource, /\{errorBlockParts\.error\.text\}/);
  assert.match(sessionPresentationSource, /label: \{\s+text: renderState\.label,\s+style: styles\.label,/);
  assert.match(sessionPresentationSource, /error: \{\s+text: error,\s+style: styles\.text,/);
  ...
  assert.match(chatMessageChromeSource, /style=\{payloadBlockParts\.scroll\.style\}/);
...
test('uses tool activities wording consistently for grouped tool activity labels', () => {
  ...
  assert.match(sessionPresentationSource, /countBadge: \{\s+shouldRender: renderState\.summary\.shouldShowToolCallCount,[\s\S]*?props: \{[\s\S]*?container: \{[\s\S]*?accessibilityLabel: renderState\.summary\.toolCallCountLabel,/);
  ...
  assert.match(sessionPresentationSource, /label: \{[\s\S]*?props: \{[\s\S]*?style: styles\.text,[\s\S]*?text: renderState\.footerButton\.label,/);
  ...
  assert.match(toolActivityGroupFooterComponentSource, /export function ChatMessageToolActivityGroupFooterLabel[\s\S]*?style=\{style\}[\s\S]*?\{text\}/);
